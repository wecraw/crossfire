export const tuesdayClues = [
    ...
    [30,"QB with the most touchdown passes in a single Super Bowl (six)","STEVEYOUNG"],
    ...
    [11,"Riddle-de-dee: What's light as a feather but can't be held for long?","YOURBREATH"],
    ...
    [18,"Absolutely adored","LOVEDTOBITS"],
    [20,"What a weekly has once a week","ISSUE"],
    [22,"Police action","ARREST"],
    [23,"The police, metaphorically","THINBLUELINE"],
    ...
    [19,"Scary landlord?","FRIGHTFULOWNER"],
    [22,"Clean with elbow grease","SCOUR"],
    [23,"Marseille Mrs.","MME"],
    [24,"Anti-fuel extraction slogan?","FRACKANDRUIN"],
    ...
    [48,"One who freely admits not being any good?","FRANKAMATEUR"],
    [51,"Time in history","ERA"],
    [52,"What light bulbs represent in comics","IDEAS"],
    [55,"What Fancy Feast and Meow Mix compete in?","FRISKYBUSINESS"],
    ...
    [27,"Quidditch ball that ends the game when it's caught","GOLDENSNITCH"],
    ...
    [46,"Comics hero with a magic ring","GREENLANTERN"],
    [50,"Decorates","ADORNS"],
    ...
    [18,"Address every aspect of something","COVERALLTHEBASES"],
    [21,"Ram's ma'am?","EWE"],
    ...
    [44,"Oddly and unexpectedly","OUTOFLEFTFIELD"],
    ...
    [57,"Situation that starts things completely over","WHOLENEWBALLGAME"],
    ...
    [12,"Camper's annoyance","INSECTBITE"],
    ...
    [16,"First African-American to win the Oscar for Best Actress","HALLEBERRY"],
    [18,"Greenish blue","AQUA"],
    [19,"He might have done it with the candlestick in the study","PROFESSORPLUM"],
    ...
    [47,"Reddit Q&A","AMA"],
    [52,"Mario's love interest in Super Mario games","PRINCESSPEACH"],
    [56,"Unexciting, as a bar scene","DEAD"],
    [57,"Pop star with the 1996 3x platinum album \"Tidal\"","FIONAAPPLE"],
    ...
    [17,"Megacorporation? [1996, 1970]","BIGCOMPANY"],
    ...
    [26,"Pomade? [1968, 1972]","HAIRGREASE"],
    ...
    [23,"\"Gross!\"","ICK"],
    [24,"Disney character based on a Dickens character","SCROOGEMCDUCK"],
    ...
    [52,"\"Hunny\"-loving A. A. Milne character","WINNIETHEPOOH"],
    ...
    [11,"Authority to broadcast","TVLICENSE"],
    [12,"Entertainment by a pool player","TRICKSHOT"],
    [13,"Look for","SEEK"],
    ...
    [33,"They provide structure, biologically","CELLWALLS"],
    [34,"Berating at high volume","YELLINGAT"],
    [36,"Mess up","ERR"],
    ...
    [18,"Helper","AIDE"],
    [19,"\"An orca is actually a dolphin?!\"","WHALEILLBEDARNED"],
    [22,"Nil","NADA"],
    ...
    [37,"\"Wow, that's a giant sea cow!\"","OHTHEHUGEMANATEE"],
    ...
    [55,"\"This is the best fish I've ever had!\"","GREATCODALMIGHTY"],
    [60,"Tear apart","REND"],
    ...
    [8,"Stood up","ROSE"],
    [9,"Big cheese","TOPDOG"],
    [10,"It may be a setup","BLINDDATE"],
    ...
    [33,"[Head shake]","UHUH"],
    [34,"\"Could go either way\"","ITDEPENDS"],
    [35,"Develops wrinkles, say","AGES"],
    [36,"Summons in Gotham City","BATSIGNAL"],
    [38,"Application","USE"],
    ...
    [17,"1,001 causes of anxiety?","MISTRESSES"],
    [19,"\"___ baby!\"","ATTA"],
    ...
    [15,"Rouse","WAKE"],
    [16,"Snitched","TOLD"],
    [17,"Representatives Sessions (R-TX) and Aguilar (D-CA), for instance?","HOUSEPETES"],
    ...
    [44,"What ice trays typically do?","BEARCUBES"],
    [46,"Its symbol is Sn","TIN"],
    [47,"Western tribe","UTE"],
    [49,"Overrule","NIX"],
    [50,"President Herbert's wife and mother, e.g.?","HOOVERDAMES"],
    ...
    [61,"Play \"Name That Tune\"?","GUESSNOTES"],
    ...
    [11,"Movement that Ms. magazine developed out of","WOMENSLIB"],
    [12,"Period enjoyed by an introvert","ALONETIME"],
    ...
    [44,"Stored deeply and securely","INTHEVAULT"],
    [47,"President pro ___","TEM"],
    [48,"H.S. class for science whizzes","APBIO"],
    [49,"Leaves ... or cleaves","SPLITS"],
    [51,"Fellow","CHAP"],
    [52,"Chocolaty treats that you might \"break me off a piece of\"","KITKATBARS"],
    ...
    [3,"Leonardo DiCaprio received four of them before winning","OSCARNODS"],
    ...
    [21,"International competition for countries that boycotted the 1984 Summer Olympics [Texas]","FRIENDSHIPGAMES"],
    ...
    [30,"Sphere","ORB"],
    [31,"45 1/2-carat gem at the National Museum of Natural History [Rhode Island]","HOPEDIAMOND"],
    [38,"Time in Boston when it's midnight in Austin","ONEAM"],
    [41,"Impose, as a tax","LEVY"],
    [42,"Shopping binge","SPREE"],
    [43,"QB's downfield throw [Wisconsin]","FORWARDPASS"],
    ...
    [57,"Companies that have big market shares [Utah]","INDUSTRYLEADERS"],
    [61,"Drug cop","NARC"],
    [62,"Helped out","AIDED"],
    ...
    [34,"Brand of school supplies known for its dazzling rainbow designs","LISAFRANK"],
    ...
    [49,"Certain emotional support animal","THERAPYDOG"],
    ...
    [18,"Hard deposit in a bladder","KIDNEYSTONE"],
    [20,"Bone-dry","ARID"],
    [21,"Dine","EAT"],
    [22,"Queen's realm?","ANTCOLONY"],
    [24,"They aren't what they appear to be","SHAMS"],
    [27,"Boxer's cry","ARF"],
    [28,"Base on balls","WALK"],
    [29,"Legislation often resulting from compromise","BIPARTISANBILL"],
    [34,"Placid","CALM"],
    [35,"Norm: Abbr.","STD"],
    ...
    [46,"N.F.L. signal caller","PROQUARTERBACK"],
    ...
    [20,"Unchangeable","WRITTENINSTONE"],
    ...
    [33,"Reds state?","OHIO"],
    [34,"Dressy floor-length garment","OPERACLOAK"],
    [37,"Molten rock","MAGMA"],
    [39,"Long, long ___","AGO"],
    [40,"___-Loompa (Willy Wonka worker)","OOMPA"],
    [41,"Something a kid might blow right through","BUBBLEWAND"],
    ...
    [35,"Dogs' \"dogs\"","PAWS"],
    [36,"What not to do over something out of your control","LOSESLEEP"],
    ...
    [18,"Nickname for baseball's Reggie Jackson","MROCTOBER"],
    [20,"Long jumper, in hoops","THREEPOINTER"],
    [22,"Call to the U.S.C.G.","SOS"],
    [23,"One of 10 felled in a strike","PIN"],
    [24,"Big name in lighters","BIC"],
    [25,"Terse affirmative","IAM"],
    [28,"Very slight probability","GHOSTOFACHANCE"],
    [32,"On vacation","AWAY"],
    ...
    [42,"Picture from Ansel Adams, say","LANDSCAPEPHOTO"],
    [46,"H.S. math class","ALG"],
    [47,"\"___ favor\"","POR"],
    [48,"Island ring","LEI"],
    [49,"Wall St. debut","IPO"],
    [54,"Relative via remarriage","STEPNIECE"],
    ...
    [20,"Cat burglar's shoe purchase?","SUCTIONPUMPS"],
    [23,"\"___ Baby\" (\"Hair\" number)","ABIE"],
    [24,"Zero score, in soccer","NIL"],
    [25,"Bon ___ (witty remark)","MOT"],
    [28,"Synchronized swimmer's shoe purchase?","WATERMOCCASINS"],
    [32,"Tops","SHIRTS"],
    ...
    [42,"Event coordinator's shoe purchase?","PARTYPLATFORMS"],
    ...
    [28,"Name of a celebrated 1970s concert tour with Bob Dylan","ROLLINGTHUNDER"],
    [35,"Foretell","BODE"],
    ...
    [46,"\"We shouldn't rush this\"","LETSTAKEITSLOW"],
    [49,"Relieve","EASE"],
    ...
    [10,"Short stiletto shoe","KITTENHEEL"],
    ...
    [30,"Tiny change to a master clock","LEAPSECOND"],
    ...
    [16,"Affected adversely, physically or psychologically","TOOKATOLLON"],
    ...
    [60,"Bringer of rain","NIMBUSCLOUD"],
    ...
    [16,"Safe for youngsters","CHILDPROOF"],
    ...
    [9,"Ablaze","ONFIRE"],
    [10,"Droplets seen early in the day","MORNINGDEW"],
    ...
    [28,"Lowest in importance","LEASTOFALL"],
    ...
    [17,"Contemporary of Booker T. Washington","WEBDUBOIS"],
    ...
    [28,"Best-selling author who invented multiple languages","JRRTOLKIEN"],
    ...
    [43,"Classic toy store founder","FAOSCHWARZ"],
    ...
    [34,"\"Pretend for a moment that you care what I want\"","INDULGEME"],
    ...
    [40,"Comic book character with the title role in a blockbuster 2018 film","THEBLACKPANTHER"],
    [43,"X amount","TEN"],
    ...
    [28,"Competition won 12 times by Rafael Nadal","FRENCHOPEN"],
    ...
    [37,"Its motto, translated from Latin, is \"If you wish for peace, prepare for war\"","ROYALNAVY"],
    ...
    [54,"Drill bit alloy","COBALTSTEEL"],
    ...
    [20,"Need for targeted advertising","CONSUMERPROFILE"],
    ...
    [39,"Netflix or YouTube","CONTENTPROVIDER"],
    ...
    [55,"It settles a case","CONCLUSIVEPROOF"],
    ...
    [20,"Purchase something sight unseen","BUYAPIGINAPOKE"],
    [22,"Prosecutors, for short","DAS"],
    [23,"Big wind","GUST"],
    [24,"Chinchilla or macaw, e.g.","EXOTICPET"],
    [28,"Snowfall unit","INCH"],
    [32,"\"Cousin\" of 1960s TV","ITT"],
    [33,"Not deceived by","ONTO"],
    [34,"Battlefield renown","GLORY"],
    [35,"1984 mockumentary with a lot of ad-libbed dialogue","THISISSPINALTAP"],
    [39,"Anti-rust coatings","ZINCS"],
    [40,"Smell","ODOR"],
    [41,"Unified","ONE"],
    [42,"Smoothie berry","ACAI"],
    [43,"Danger of laboring outdoors in the summer","SUNSTROKE"],
    [46,"Panache","ELAN"],
    [48,"___ Lingus","AER"],
    [56,"Brain region linked to speech","BROCASAREA"],
    ...
    [16,"Actor who won an Oscar for 1950's \"Cyrano de Bergerac\"","JOSEFERRER"],
    ...
    [23,"Pipe type","BRIAR"],
    [25,"Sugar suffix","OSE"],
    [28,"Longtime rival of Roger Federer","RAFAELNADAL"],
    [33,"Gambling card game","FARO"],
    [35,"Oodles","LOTS"],
    [36,"Actress Blunt","EMILY"],
    [37,"Dictator following the Spanish Civil War","FRANCISCOFRANCO"],
    [40,"Famous Ford failure","EDSEL"],
    [41,"Hacienda room","SALA"],
    [42,"Very bright, as colors","NEON"],
    [43,"A founder of Mexican muralism","DIEGORIVERA"],
    ...
    [10,"\"Monster's Ball\" Oscar winner","HALLEBERRY"],
    ...
    [9,"That: Sp.","ESO"],
    [10,"Sources of urban noise pollution","CARALARMS"],
    ...
    [31,"Brewed drink","TEA"],
    [32,"Intense promotional campaigns","ADBLITZES"],
    ...
    [17,"\"The wart stops here\" sloganeer","COMPOUNDW"],
    ...
    [37,"So-called \"millennials\"","GENERATIONY"],
    ...
    [28,"Difficulties in life","HARDKNOCKS"],
    ...
    [17,"Stop before it can grow bigger","NIPINTHEBUD"],
    ...
    [26,"British fashion designer who's the daughter of Linda and Sir Paul","STELLAMCCARTNEY"],
    ...
    [43,"Very rarely","ONCEINABLUEMOON"],
    ...
    [57,"Long, straight-sided smoke","CORONACIGAR"],
    ...
    [19,"Endorsement from a brand's account?","COMPANYRETWEET"],
    [22,"Desert rarity","RAIN"],
    [23,"Posh","SWANKY"],
    [24,"Some Halloween candy discovered in February?","OLDBAGOFTWIX"],
    ...
    [40,"When the whole clan gets their eyebrows done?","FAMILYTWEEZE"],
    [42,"They hold hands","WRISTS"],
    [45,"\"___ it the truth!\"","AINT"],
    [46,"CliffsNotes version of \"Huckleberry Finn\"?","HIGHSPEEDTWAIN"],
    ...
    [17,"It resulted in human language division, per Genesis","THETOWEROFBABEL"],
    ...
    [27,"It's better than what's not familiar, in a saying","THEDEVILYOUKNOW"],
    ...
    [48,"Classic American novel set in France and Spain","THESUNALSORISES"],
    [52,"Scorch","SEAR"],
    ...
    [17,"Interested in experimenting sexually, maybe","BICURIOUS"],
    ...
    [26,"Stick with U.S.-made products","BUYAMERICAN"],
    ...
    [10,"Things to keep on hand to prevent burns?","OVENMITTS"],
    [11,"Skype call, say","VIDEOCHAT"],
    ...
    [16,"Uncooked","RAW"],
    [17,"The sitcom writers met at a ...","TVRECEPTION"],
    ...
    [28,"The mathematicians met at a ...","TRIGFUNCTION"],
    ...
    [46,"The pharmacists met at a ...","MEDICINEBALL"],
    [48,"Top-notch","ELITE"],
    [49,"\"Methinks\"","IRECKON"],
    ...
    [58,"The Google employees met at a ...","SEARCHPARTY"],
    ...
    [34,"Male/female pay differential, e.g.","GENDERGAP"],
    ...
    [17,"2016 live-action Disney film with an animated title character","PETESDRAGON"],
    ...
    [27,"Where John Milton and John Oliver studied at Cambridge","CHRISTSCOLLEGE"],
    [32,"Bumpkin","YAHOO"],
    [33,"Corrida cry","OLE"],
    ...
    [47,"1933 Erskine Caldwell novel about a wealth-obsessed farm family","GODSLITTLEACRE"],
    ...
    [60,"Notorious cinematic flop of 1980","HEAVENSGATE"],
    [64,"\"My man\"","BRO"],
    ...
    [17,"One who's taking a polar vortex pretty hard?","COLDSOBBER"],
    [19,"\"Ah, now I see\"","OHOK"],
    [20,"Wonder","AWE"],
    [21,"\"Whatever you say\"","SURE"],
    [22,"Conscious","AWARE"],
    [23,"One who cheats on a weight-reduction plan?","DIETARYFIBBER"],
    ...
    [47,"Heyday of taxis in Beijing?","CHINESECABAGE"],
    [53,"D.J.'s version of a song","REMIX"],
    [54,"He loves, she loves, or it loves: Lat.","AMAT"],
    [55,"Place for a baby","LAP"],
    [58,"Too","ALSO"],
    [59,"Defense against a charge of public nudity?","WEWASROBED"],
    [62,"Cordon ___","BLEU"],
    ...
    [20,"Where one might find Boston news reporters?","AROUNDTHEGLOBE"],
    ...
    [36,"Crab traps","POTS"],
    [37,"Where a Baltimore news reader's desk might be found?","UNDERTHESUN"],
    ...
    [56,"Beaten to a news scoop in Los Angeles?","BEHINDTHETIMES"],
    ...
    [9,"Locale for an outdoor Japanese party","TEAGARDEN"],
    [10,"___ Bell","TACO"],
    ...
    [34,"Greece/Turkey separator","AEGEANSEA"],
    ...
    [37,"Bronzer in a bottle","SUNTANOIL"],
    ...
    [18,"Simple, simple, simple [1,2,3]","EASYASABC"],
    ...
    [68,"Diplomatic controversy of the 1790s [24,25,26]","XYZAFFAIR"],
    ...
    [17,"Xena, notably","WARRIORPRINCESS"],
    ...
    [27,"Largest lizard on earth (up to 10 feet long)","KOMODODRAGON"],
    ...
    [47,"Who sang the 1973 #1 hit \"Midnight Train to Georgia\"","GLADYSKNIGHT"],
    ...
    [2,"Pizazz","ELAN"],
    [3,"Some classroom wall hangings","WORLDMAPS"],
    ...
    [17,"Actress McCarthy is wandering","MELISSASAIMLESS"],
    ...
    [32,"Approx.","EST"],
    [33,"Designer McCartney is prepared","STELLASALLSET"],
    [37,"Campaign undertaking","POLL"],
    [38,"Helpful","UTILE"],
    [39,"___ Reader (quarterly magazine)","UTNE"],
    [42,"Supermodel Hutton is incredible","LAURENSUNREAL"],
    ...
    [60,"Singer Love is erudite","DARLENESLEARNED"],
    [64,"\"I'm shocked!\"","OMG"],
    [65,"Pin point?","LAPEL"],
    ...
    [11,"Still preferable","EVENBETTER"],
    ...
    [29,"Competitor of Chase and Citibank","WELLSFARGO"],
    ...
    [17,"16-ounce sirloin that Shylock brought to the cookout?","THEPOUNDOFFLESH"],
    [20,"Dow Jones, e.g.","INDEX"],
    [21,"One less than penta-","TETRA"],
    [22,"Reluctant to make eye contact, maybe","SHY"],
    [23,"Three on a sundial","III"],
    [25,"End part","TAIL"],
    [27,"Mark Antony's request to the farmer when he realized he didn't have enough corn for the cookout?","LENDMEYOUREARS"],
    ...
    [48,"Cry from Hamlet when he spotted his favorite spice mix at the cookout?","AYTHERESTHERUB"],
    ...
    [64,"Lady Macbeth's declaration upon checking the steaks at the cookout?","WHATSDONEISDONE"],
    ...
    [22,"Eponym of a certain tennis stadium in Queens","ARTHURASHE"],
    ...
    [53,"Measure fully ratified on 8/18/1920","AMENDMENTXIX"],
    ...
    [16,"Cousin of Simon Says","MOTHERMAYI"],
    ...
    [34,"Facial wrinkle suggesting a jovial spirit","LAUGHLINE"],
    [35,"\"Jane ___\"","EYRE"],
    ...
    [11,"Dance floor request","MAYICUTIN"],
    ...
    [34,"Youth-oriented Cond\u00e9 Nast publication","TEENVOGUE"],
    ...
    [15,"Per item","APOP"],
    [16,"\"I'm game -- just give me the signal\"","READYWHENYOUARE"],
    [19,"Iowa senator Ernst","JONI"],
    [20,"Kind of cord for a daredevil","BUNGEE"],
    [21,"Emmy-nominated Lucy","LIU"],
    [23,"___-ray Disc","BLU"],
    [25,"Costa ___","RICA"],
    [26,"Celtics player-turned-executive","DANNYAINGE"],
    ...
    [47,"Something to take after a garlicky meal","BREATHMINT"],
    ...
    [10,"In quite a spot","UPAGAINSTIT"],
    [11,"Yawner","BORE"],
    ...
    [17,"1990 #1 hit that begins \"Yo, V.I.P., let's kick it!\"","ICEICEBABY"],
    [20,"The \"p\" of m.p.h.","PER"],
    [21,"Rock's Kings of ___","LEON"],
    [22,"Retro photo tint","SEPIA"],
    [23,"Main drag through New Orleans's French Quarter","BOURBONSTREET"],
    ...
    [6,"Punctuation that may mean \"or\"","SLASHMARK"],
    ...
    [29,"Comment made while shaking the head","WHATASHAME"],
    ...
    [14,"Kismet","FATE"],
    [15,"Protective garments worn for dental X-rays","LEADAPRONS"],
    [17,"Let the host know","RSVP"],
    [18,"Project's windup","FINALPHASE"],
    [19,"90\u00b0 on a compass","EAST"],
    [20,"India ___","INK"],
    [21,"Not stereo","MONO"],
    [22,"Hefty lexical ref.","OED"],
    [23,"Competitor of Petro-Canada","ESSO"],
    [25,"Grated food flavorer used in baking","LEMONZEST"],
    ...
    [39,"About half of a regular-season schedule","HOMEGAMES"],
    [41,"Gold-coated","GILT"],
    ...
    [55,"Set in direct opposition to","PITAGAINST"],
    ...
    [14,"Playground game with teams","FREEZETAG"],
    [16,"Pollutant concentration meas.","PPM"],
    [22,"Burger topper","ONION"],
    [24,"Accepting bribes","ONTHETAKE"],
    ...
    [18,"What the computer Deep Thought was programmed to figure out in \"The Hitchhiker's Guide to the Galaxy\"","THEMEANINGOFLIFE"],
    ...
    [36,"Pigeon sound","COO"],
    [37,"Hall-of-Fame player whose number has been retired by every team in Major League Baseball","JACKIEROBINSON"],
    [41,"Young 'un","TOT"],
    [43,"Mer contents","EAU"],
    [44,"Sharpen","WHET"],
    ...
    [56,"He served between Bush 41 and Bush 43","PRESIDENTCLINTON"],
    ...
    [28,"\"That's impossible!\"","ITCOULDNTBE"],
    ...
    [18,"Big corporate news","STOCKSPLIT"],
    ...
    [58,"Stick (to)","ADHERE"],
    [59,"1956 Mideast imbroglio","SUEZCRISIS"],
    ...
    [6,"CPR expert","EMT"],
    [7,"Wise as ___","ANOWL"],
    [8,"\"Pretty Woman\" co-star","RICHARDGERE"],
    ...
    [42,"Facial hair for Sam Elliott and Wilford Brimley","WALRUSMUSTACHE"],
    ...
    [2,"Squarish","BOXY"],
    [3,"Necessity for achieving one's goals?","SOCCERBALL"],
    ...
    [29,"Caffeinated summer drink","ICEDCOFFEE"],
    [30,"\"You betcha!\"","UHHUH"],
    ...
    [18,"Item in a game of jackstraws","PICKUPSTICK"],
    ...
    [32,"Attempt to fix something and inadvertently make the situation worse","OPENACANOFWORMS"],
    [35,"Spring mo.","APR"],
    [36,"Reaction to a gut punch","OOF"],
    [37,"Go easy on the criticism","TAKEASOFTLINE"],
    ...
    [44,"Device for pulling a vehicle","TOWINGWINCH"],
    ...
    [27,"Perfect partner for life","ONEANDONLY"],
    ...
    [20,"Compensating reduction of greenhouse gas emissions","CARBONOFFSET"],
    ...
    [55,"Greedy person's cry","MINEMINEMINE"],
    ...
    [15,"Border","ABUT"],
    [16,"It has spots","PARKINGLOT"],
    [18,"\"___ #1!\"","WERE"],
    [19,"Like a fox","SLY"],
    [20,"Fertile soil","LOAM"],
    [21,"Jackson of country music","ALAN"],
    [22,"It has spots","LEOPARDPRINT"],
    ...
    [35,"It has spots","COMMERCIALBREAK"],
    ...
    [9,"Still","YET"],
    [10,"\"To the best of my knowledge\"","IBELIEVESO"],
    ...
    [28,"Source of day workers for an office","TEMPAGENCY"],
    [31,"Unburden (of)","RID"],
    ...
    [20,"Regulation regarding a 2007 #1 Rihanna hit?","UMBRELLAPOLICY"],
    ...
    [33,"Special observances for a 2014 #1 Pharrell Williams hit?","HAPPYHOLIDAYS"],
    [37,"\"Damn right!\"","AMEN"],
    [39,"Cry before \"set, go!\"","READY"],
    [40,"Tick off","RILE"],
    [41,"1994 #1 Lisa Loeb hit played at a potluck?","STAYFORDINNER"],
    ...
    [53,"1979 #1 Styx hit played for Little Red Riding Hood?","BABEINTHEWOODS"],
    ...
    [9,"Swashbuckling leading man","ERROLFLYNN"],
    ...
    [18,"2012 Grammy winner for \"Channel Orange\"","FRANKOCEAN"],
    [20,"Born: Fr.","NEE"],
    ...
    [59,"Networks that deliver electricity","POWERGRIDS"],
    ...
    [48,"Longtime host of \"The Price Is Right\"","BOBBARKER"],
    ...
    [54,"Power user of a popular review site, colloquially","ELITEYELPER"],
    [57,"Fashionable","HIP"],
    ...
    [15,"1992 Brendan Fraser film about a thawed Cro-Magnon","ENCINOMAN"],
    ...
    [4,"Accounts of Paul Bunyan, say","TALLTALES"],
    [5,"Tenant","LESSEE"],
    ...
    [17,"Popular shooter in the Old West","DERRINGERPISTOL"],
    ...
    [25,"Puts one's own slant on the past","REWRITESHISTORY"],
    ...
    [42,"W.W. I leader","PRESIDENTWILSON"],
    ...
    [55,"Vietnamese noodle salads","VERMICELLIBOWLS"],
    ...
    [11,"They get wetter as they dry","BATHTOWELS"],
    ...
    [23,"Hot fudge or caramel sauce?","SPLITDECISION"],
    ...
    [3,"Attends to one's mental health, say","STAYSSANE"],
    [4,"L.A. school","USC"],
    ...
    [17,"One who may have a mortgage","HOMEOWNER"],
    ...
    [36,"Your: Fr.","TES"],
    [37,"Liquid supply for body art","TATTOOINK"],
    [41,"\"Eww!\"","ICK"],
    [44,"Bird that usually mates for life","SWAN"],
    [45,"Word before fairy or decay","TOOTH"],
    [49,"Message between two arrows on a shipping container","THISSIDEUP"],
    ...
    [9,"Decoration for some die-hard sports fans","FACEPAINT"],
    ...
    [18,"Lighting display at many a rock concert","LASERSHOW"],
    [20,"Overdue amount","ARREAR"],
    [22,"Strike callers","UNIONS"],
    [23,"Symbol of pride","RAINBOWFLAG"],
    ...
    [46,"Comeuppance for a package thief","GLITTERBOMB"],
    ...
    [4,"#2 for #44","BIDEN"],
    [5,"\"Things may well not happen the way you suppose\"","ITSABIGIF"],
    ...
    [32,"Clark Kent and Mr. Hyde, for two","ALTEREGOS"],
    ...
    [17,"Classic activity for family night","BOARDGAME"],
    ...
    [28,"Serving in a bowl with milk","BREAKFASTCEREAL"],
    ...
    [50,"Periodical format not much seen nowadays","PICTUREMAGAZINE"],
    ...
    [3,"Mascot on cookie boxes","KEEBLERELF"],
    ...
    [27,"David Bowie hit with the lyric \"You've torn your dress, your face is a mess\"","REBELREBEL"],
    [28,"Boozehound","SOUSE"],
    ...
    [15,"Apt phrase that uses just the letters of U.S. CAPITOL","POLITICSASUSUAL"],
    ...
    [25,"Apt phrase that uses just the letters of UNEARTHS","TREASUREHUNTER"],
    [31,"Phone no.","TEL"],
    ...
    [42,"Apt phrase that uses just the letters of GRAND TIME","GETTINGMARRIED"],
    ...
    [55,"Angry state","IRE"],
    [56,"Apt phrase that uses just the letters of MASTERING","TRAININGSEMINAR"],
    ...
    [3,"One who plays alone","SOLOARTIST"],
    ...
    [28,"Cloth napkins and such","TABLELINEN"],
    ...
    [14,"Tiny fly","MIDGE"],
    [15,"Copy","APE"],
    [16,"Job interview for a wannabe tax collector?","IRSAUDITION"],
    ...
    [34,"What the surfing enthusiast has?","BOARDINGPASSION"],
    [38,"\"Movin' ___\"","ONUP"],
    [39,"Preceder of \"TV\" on cable TV","TRU"],
    [40,"Brand of cornstarch","ARGO"],
    [41,"Name for a huge marathon?","RUNOFTHEMILLION"],
    ...
    [16,"___ Jima","IWO"],
    [17,"Actor with the same initials as Michael Rezendes, his role in \"Spotlight\"","MARKRUFFALO"],
    [19,"Nuke","ZAP"],
    ...
    [59,"Army NCO","SGT"],
    [61,"Grassy field","LEA"],
    [62,"Actor with the same initials as Jake Blues, his role in \"The Blues Brothers\"","JOHNBELUSHI"],
    ...
    [11,"Actress with the same initials as Linda Marolla, her role in \"Arthur\"","LIZAMINNELLI"],
    [12,"Come to","AWAKEN"],
    ...
    [25,"Actor with the same initials as Jefferson Smith, his role in \"Mr. Smith Goes To Washington\"","JAMESSTEWART"],
    ...
    [18,"Video game franchise in which the enemies are pigs","ANGRYBIRDS"],
    ...
    [33,"Pub pints","ALES"],
    [34,"Feline in an internet meme","GRUMPYCAT"],
    ...
    [57,"1980 boxing biopic","RAGINGBULL"],
    ...
    [33,"\"Be that as it may ...\"","ATANYRATE"],
    ...
    [17,"Excessively ornate writing","PURPLEPROSE"],
    ...
    [30,"Some sweet cocktails","BANANADAIQUIRIS"],
    ...
    [46,"Did something hugely risky","COURTEDDISASTER"],
    ...
    [36,"You might learn a new language to write one","COMPUTERPROGRAM"],
    ...
    [5,"Get into a fistfight","DUKEITOUT"],
    [6,"Doggie sound","ARF"],
    ...
    [29,"Messes up","ERRS"],
    [33,"Slightly","ATAD"],
    [35,"1980s soca hit with the lyric \"Me mind on fire, me soul on fire\"","HOTHOTHOT"],
    ...
    [18,"Article of headwear for an explosives engineer?","BLASTINGCAP"],
    ...
    [32,"Breadth","EXTENT"],
    [35,"Article of neckwear for the Stooges?","THREEWAYTIE"],
    ...
    [42,"Wrist accessory for a celebrity magazine editor?","PEOPLEWATCH"],
    ...
    [60,"Waist accessory for a Russian cook?","BORSCHTBELT"],
    ...
    [29,"Noted Lakota leader","CRAZYHORSE"],
    ...
    [18,"Wanders","ROVES"],
    [19,"Dressed like \"a hundred-dollar millionaire\"","ALLFLASHNOCASH"],
    ...
    [36,"\"I think I made a mistake here\"","THATCANTBERIGHT"],
    ...
    [50,"\"Add some throw pillows or a pop of color around here, why don't you!\"","JAZZUPTHEPLACE"],
    ...
    [36,"Beverage brand whose first mascot was Willy the Hillbilly","MOUNTAINDEW"],
    ...
    [52,"Part of San Diego that's home to its zoo","BALBOAPARK"],
    [56,"___ Lingus","AER"],
    ...
    [3,"Compete intellectually (with)","MATCHWITS"],
    ...
    [47,"Very wee","EENSIE"],
    [48,"Embarrassing fall","FACEPLANT"],
    [58,"Male buds","BROS"],
    ...
    [2,"Flinched","BATTEDANEYE"],
    [3,"Adjuncts to some penthouses","ROOFGARDENS"],
    [4,"Nile viper","ASP"],
    [5,"State as fact","AVER"],
    [6,"Org. for docs","AMA"],
    [7,"Military field uniform","BATTLEDRESS"],
    [8,"World's highest-paid athlete in 2019, per Forbes magazine","LIONELMESSI"],
    ...
    [16,"At the big brawl, the jazz musician ...","CAMEOUTSWINGING"],
    ...
    [35,"Refer to","CITE"],
    [36,"At the big brawl, the hairstylist ...","BOBBEDANDWEAVED"],
    ...
    [55,"At the big brawl, the king and queen ...","PUTUPTHEIRDUKES"],
    ...
    [10,"Subject of the saying \"Leaves of three, let it be\"","POISONIVY"],
    ...
    [33,"Informed about","ABREASTOF"],
    [34,"Dippable snack item","NACHOCHIP"],
    ...
    [36,"\"Think box\"","NOGGIN"],
    [37,"Get ready for something amazing","HANGONTOYOURHAT"],
    ...
    [57,"Cuts back","PARES"],
    [58,"Don't spend so much money","TIGHTENYOURBELT"],
    ...
    [17,"Best Actor winner for \"The King's Speech\"","COLINFIRTH"],
    [19,"The \"A\" of I.R.A.: Abbr.","ACCT"],
    [20,"Jenner of \"Keeping Up With the Kardashians\"","KRIS"],
    [21,"Actor who played Dagwood Bumstead in film, radio and TV","ARTHURLAKE"],
    ...
    [55,"Singer with the 1984 #1 hit \"Caribbean Queen\"","BILLYOCEAN"],
    [58,"Paths of fly balls","ARCS"],
    [59,"Jai ___","ALAI"],
    [60,"\"Pearl Harbor\" director, 2001","MICHAELBAY"],
    ...
    [20,"Google or Yahoo offering","FREEEMAIL"],
    [22,"Payroll ID, for short","SSN"],
    [23,"FedEx alternative","DHL"],
    [25,"Aries animal","RAM"],
    [26,"Betty White's role on \"The Mary Tyler Moore Show\"","SUEANNNIVENS"],
    ...
    [45,"Moniker of an 18th-century British statesman","PITTTHEELDER"],
    [48,"Answer to \"Who is?\"","IAM"],
    [49,"AOL alternative","MSN"],
    [50,"Engine part","CAM"],
    [53,"Sorting criterion at the women's department","DRESSSIZE"],
    [58,"Massive","HUGE"],
    ...
    [17,"Proper attire for taking fingerprints?","DUSTJACKET"],
    [19,"Enter","GOIN"],
    [20,"Dramatic \"You too?\"","ETTU"],
    [21,"Mauna ___","KEA"],
    [22,"Bat for hitting practice fly balls","FUNGO"],
    [23,"Red, white and blue team","USA"],
    [24,"Proper attire for picking up a series of clues?","TRAILBLAZER"],
    ...
    [50,"Proper attire for detaining a perp?","HOLDINGTANK"],
    [53,"More of an ___ than a science","ART"],
    [54,"Barely beat (out)","EDGED"],
    [55,"Massage","RUB"],
    [56,"Vittles","EATS"],
    [58,"Sign gas","NEON"],
    [59,"Proper attire for shadowing a suspect?","FOLLOWSUIT"],
    ...
    [31,"Ones far from the honor roll","DSTUDENTS"],
    [33,"Caboose, e.g.","END"],
    ...
    [19,"\"Montage of a Dream Deferred\" poet","LANGSTONHUGHES"],
    ...
    [29,"\"The Interpretation of Dreams\" writer","SIGMUNDFREUD"],
    [33,"Macho sorts","HEMEN"],
    [34,"Dictator Amin","IDI"],
    [35,"\"HAHAHA!,\" in texts","ROTFL"],
    [39,"\"Dream Caused by the Flight of a Bee Around a Pomegranate a Second Before Awakening\" artist","SALVADORDALI"],
    ...
    [52,"\"All I Have to Do Is Dream\" singers","EVERLYBROTHERS"],
    [56,"States of emergency","REDALERTS"],
    ...
    [47,"Longest-serving Independent member of Congress in U.S. history","BERNIESANDERS"],
    [53,"Vaccine target","FLU"],
    [55,"Greeting in Guatemala","HOLA"],
    [56,"Generate by dubious means","GINUP"],
    [57,"Part of a Juliet soliloquy","ROMEOROMEO"],
    ...
    [34,"Obvious signs of pregnancy","BABYBUMPS"],
    ...
    [17,"Psychedelic stuff from the Evergreen State?","WASHROOMS"],
    ...
    [64,"Pasta from the Golden State?","CANOODLES"],
    ...
    [30,"Sign of hospitality","WELCOMEMAT"],
    [31,"Backside","RUMP"],
    ...
    [44,"Hawaii ___ National Park","VOLCANOES"],
    ...
    [57,"End of the world","APOCALYPSE"],
    ...
    [3,"B-52s hit named by Rolling Stone as the best single of 1989","LOVESHACK"],
    ...
    [17,"\"Take a deep breath ...\"","TRYTORELAX"],
    ...
    [33,"PDF, JPEG and others","FILETYPES"],
    [34,"Portion (out)","DOLE"],
    ...
    [19,"\"The race has just begun, and it looks like the car from Warsaw will ___!\"","POLEINTOFIRST"],
    [22,"Religious recluse","EREMITE"],
    [23,"Basic readings for a hospital patient","VITALS"],
    [26,"Lungful","AIR"],
    [27,"Hook's henchman","SMEE"],
    [29,"In good health","FIT"],
    [30,"\"Listen! You can hear the thundering roar as the car from Moscow goes ___!\"","RUSSIANPAST"],
    [34,"Letters on a wanted poster","AKA"],
    [35,"Supermarket IDs","UPCS"],
    [36,"Something kept in reserve?","OIL"],
    [37,"Worry","FRET"],
    [38,"Negative conjunction","NOR"],
    [39,"\"We're getting close to the end as the car from Helsinki leads the way to the ___!\"","FINNISHLINE"],
    ...
    [52,"\"Wow! The car from Prague ekes out the victory by a nose and takes the ___!\"","CZECHEREDFLAG"],
    ...
    [18,"Frank discussion, perhaps","MANTOMANTALK"],
    [20,"Nobelist Wiesel","ELIE"],
    [22,"Same old, same old","RUT"],
    [23,"Caper","ANTIC"],
    [24,"Courses without letter grades","PASSFAILCLASSES"],
    ...
    [50,"Fleur-de-___","LIS"],
    [52,"God, in Italy","DIO"],
    [53,"By whatever means","CATCHASCATCHCAN"],
    [60,"Taste that is neither sweet nor salty nor sour nor bitter","UMAMI"],
    [61,"Sashimi fish","AHI"],
    [62,"Collect, with \"in\"","RAKE"],
    [63,"1970 W.W. II drama with a repetitive name","TORATORATORA"],
    ...
    [11,"Cold War competition","SPACERACE"],
    ...
    [17,"Comedian who'd make a good pyrotechnician?","GEORGEBURNS"],
    [19,"The Dolphins or the Heat, on scoreboards","MIA"],
    [20,"\"___ or sugar?\"","CREAM"],
    [21,"Youngster","TOT"],
    [22,"Lady birds","HENS"],
    [23,"Completely smash","TOTAL"],
    [24,"Supermodel who'd make a good broker?","TYRABANKS"],
    [26,"___ Baba","ALI"],
    ...
    [35,"Activist who'd make a good valet?","ROSAPARKS"],
    ...
    [53,"Rapper who'd make a good barber?","SEANCOMBS"],
    [55,"Not kind","HARSH"],
    ...
    [61,"Actor who'd make a good dry cleaner?","JEREMYIRONS"],
    [64,"-: Abbr.","NEG"],
    [65,"Reach","ATTAIN"],
    ...
    [16,"Diamond stat","RBI"],
    [17,"Jane Goodall, at times?","APERECORDER"],
    ...
    [26,"Corn farmer at harvest time?","EARJERKER"],
    ...
    [51,"Lumberjacks in unsafe working conditions?","AXDODGERS"],
    [55,"Declaration in a swearing-in ceremony","IDO"],
    [56,"Mecca resident","SAUDI"],
    [57,"Make muddy, as water","ROIL"],
    [59,"Figure (out)","SUSS"],
    [62,"\"Ewww!\"","ICK"],
    [63,"Caterer's coffee dispenser?","URNOFEVENTS"],
    [66,"Broke a fast","ATE"],
    ...
    [3,"Final words of many a fairy tale","EVERAFTER"],
    ...
    [16,"\"Omigosh, girl!\"","HEAVENSTOBETSY"],
    [19,"\"Reckon so\"","ISPOSE"],
    [20,"Quagmire","MORASS"],
    [21,"Specifics, in slang","DEETS"],
    [22,"\"Uh, yeah!\"","TOTES"],
    [23,"\"Dang, girl!\"","GEEZLOUISE"],
    [28,"Scare word","BOO"],
    ...
    [10,"Event for antique lovers","ESTATESALE"],
    [11,"Crew","POSSE"],
    ...
    [52,"Noted 1950s-'70s D.J. dubbed a \"fifth Beatle\"","MURRAYTHEK"],
    [56,"Basic idea","GIST"],
    [57,"Start of \"The Star-Spangled Banner\"","OSAY"],
    [58,"Seeks legal recourse","SUES"],
    [59,"\"Is everything all right?\"","AREYOUOKAY"],
    ...
    [16,"Big fib","LIE"],
    [17,"View off the coast of Miami","BISCAYNEBAY"],
    ...
    [24,"One who helps you hit just the right note","VOCALCOACH"],
    ...
    [17,"\"Oh, it's nothing to concern yourself with\"","IGNORETHAT"],
    ...
    [23,"Omits mention of","LEAVESUNSAID"],
    [26,"Lethargy","MALAISE"],
    ...
    [24,"Object commonly worn by someone under house arrest","ANKLEMONITOR"],
    [27,"Part of a buck","ANTLER"],
    [30,"Pamper","BABY"],
    [31,"Sheep's sound","BAA"],
    [32,"Word before we or flush","ROYAL"],
    [36,"Greek H's","ETAS"],
    [39,"One making a scene outdoors","LANDSCAPEARTIST"],
    ...
    [10,"Fury","IRE"],
    [11,"Advice much seen in Cosmopolitan and Seventeen","BEAUTYTIPS"],
    [12,"Low voice","BASSO"],
    ...
    [29,"Conveyance for two","TANDEMBIKE"],
    ...
    [45,"\"Oh, come on now!\"","GETOUTTAHERE"],
    [48,"Little Rock-to-Chicago dir.","NNE"],
    [49,"Reminder of an old flame?","ASHES"],
    [53,"\"How ridiculous!\"","THATSCRAZYTALK"],
    [59,"Hot seasoning made with peppers","CHILISAUCE"],
    ...
    [17,"Like a happy astronaut?","OVERTHEMOON"],
    ...
    [24,"Like a happy portrait model?","SITTINGPRETTY"],
    ...
    [38,"Like a happy mountaineer?","ONTOPOFTHEWORLD"],
    ...
    [49,"Like a happy medium?","INGOODSPIRITS"],
    [53,"Prefix with ribonucleic","DEOXY"],
    [54,"Connections","INS"],
    [55,"Rug rat","TOT"],
    [58,"Something that may be chocolate-coated?","LAB"],
    [59,"Like a happy meteorologist?","ONCLOUDNINE"],
    [64,"H","ETA"],
    [65,"Pouty face","MOUE"],
    ...
    [9,"Item waved at a rave","GLOWSTICK"],
    ...
    [37,"Where visitors may stay","GUESTROOM"],
    ...
    [20,"Dreaming state","HEADINTHECLOUDS"],
    ...
    [36,"Practical state","FEETONTHEGROUND"],
    ...
    [48,"Dalai ___","LAMA"],
    [49,"Crass state","MINDINTHEGUTTER"],
    ...
    [17,"\"This hot dog is absolute perfection!,\" said Tom ___","WITHRELISH"],
    ...
    [3,"View in order to mock or criticize, perhaps","HATEWATCH"],
    ...
    [8,"Intoxicate","BESOT"],
    [9,"\"Fargo\" assent","YAH"],
    [10,"Transport onto the Enterprise, in a way","BEAMABOARD"],
    [11,"Kick out","EXPEL"],
    [12,"Rope fiber","SISAL"],
    ...
    [27,"Accept blame","TAKETHERAP"],
    [29,"Pie ___ mode","ALA"],
    [30,"Vegas intro","LAS"],
    [31,"Low-spirited","SAD"],
    [32,"Truffle-finding animal","PIG"],
    [33,"\"___ the Force, Luke\"","USE"],
    [35,"Glaring inconsistencies in story lines","PLOTHOLES"],
    [36,"Golfer Ernie","ELS"],
    ...
    [48,"Unrealistic, as wishes, literally","THEPIESKY"],
    ...
    [53,"Marijuana","WEED"],
    [55,"\"Years ago ...,\" literally","THEBACKDAY"],
    ...
    [40,"Mindless","INANE"],
    [41,"Affectionate nickname for the \"Father of the Symphony\"","PAPAHAYDN"],
    ...
    [59,"Comforting mental state","HAPPYPLACE"],
    ...
    [3,"Manages to gather, as cash","SCRAPESUP"],
    [4,"Heaven","SHANGRILA"],
    ...
    [19,"Research findings that can't be reproduced, say","BADSCIENCE"],
    [21,"Field of mathematics pioneered by John von Neumann","GAMETHEORY"],
    ...
    [17,"Autobiography of a \"Star Trek\" doctor?","BEINGMCCOY"],
    [19,"Mental flash","IDEA"],
    [20,"Afternoon affair","TEA"],
    [21,"Rib","KID"],
    [22,"Audre Lorde or Lord Byron","POET"],
    [23,"Kill off a major \"Back to the Future\" character?","SACRIFICEMCFLY"],
    ...
    [51,"Film star Danny hurriedly leaving the set?","RUNAWAYMCBRIDE"],
    [56,"Mayberry sot","OTIS"],
    [57,"Bemoan","RUE"],
    [58,"Medit. country","ISR"],
    [59,"Something to watch on the telly, with \"the\"","BEEB"],
    [60,"Help film star Steve recover from an action sequence?","ICEMCQUEEN"],
    ...
    [3,"Niacin and riboflavin","BVITAMINS"],
    ...
    [34,"Wildly improbable goal","PIPEDREAM"],
    ...
    [23,"Some romantic entanglements","LOVETRIANGLES"],
    ...
    [36,"Things clinked on New Year's Eve","CHAMPAGNEFLUTES"],
    ...
    [47,"Interviewing aids","TAPERECORDERS"],
    ...
    [57,"Subjects of health class diagrams","SEXORGANS"],
    ...
    [33,"Item made unnecessary by a pull tab","CANOPENER"],
    ...
    [17,"They often come out at night","FALSETEETH"],
    ...
    [28,"First lady of 2001 to '09","LAURABUSH"],
    ...
    [47,"Was destined to fail","HADNOHOPE"],
    ...
    [61,"Darling","DEAR"],
    [62,"Host of Marco Polo","KUBLAIKHAN"],
    ...
    [17,"\"You want to fight?!\"","BRINGITON"],
    ...
    [17,"Unadorned","BARE"],
    [18,"Honolulu-based carrier, informally","HAWAIIANAIR"],
    ...
    [27,"Piece of pottery featuring Achilles, say","GREEKVASE"],
    ...
    [50,"Military bottoms, informally","CAMOPANTS"],
    ...
    [58,"Made snappy comments","WISECRACKED"],
    ...
    [17,"All that a greedy businessperson thinks about?","MONEYMONEYMONEY"],
    ...
    [39,"Demand made with hands outstretched?","GIMMEGIMMEGIMME"],
    ...
    [61,"Particularly enthusiastic cry at the altar?","IDOIDOIDOIDOIDO"],
    ...
    [28,"Common grilled cheese sandwich go-with","TOMATOSOUP"],
    ...
    [16,"Give a hoot","CARE"],
    [17,"Super-cold spell on the set of a 1996 Broadway musical?","RENTFREEZE"],
    ...
    [57,"Suds maker","SOAP"],
    [58,"Positive, albeit terse, review of a 2003 Broadway musical?","WICKEDGOOD"],
    ...
    [11,"Souvenir from a 1968 Broadway musical?","HAIRSHIRT"],
    ...
    [34,"Performance venue for a 1977 Broadway musical?","ANNIEHALL"],
    ...
    [20,"Child, to doting parents","PRIDEANDJOY"],
    [23,"Offshoot of punk music","EMO"],
    [24,"\"That being said ...\"","YET"],
    [25,"Classic Hunter S. Thompson novel, familiarly","FEARANDLOATHING"],
    ...
    [41,"Strategy during the 2003 invasion of Iraq","SHOCKANDAWE"],
    ...
    [10,"Takedowns at dojos","JUDOTHROWS"],
    ...
    [17,"Experience, redundantly","PASTHISTORY"],
    [19,"Opus ___","DEI"],
    ...
    [38,"Moolah, redundantly","CASHMONEY"],
    ...
    [64,"Cottontail, redundantly","BUNNYRABBIT"],
    ...
    [36,"Building where the \"Ninety-Five Theses\" were posted","ALLSAINTSCHURCH"],
    ...
    [10,"Body of water bordering Seattle","PUGETSOUND"],
    ...
    [51,"Like some August sales","BACKTOSCHOOL"],
    ...
    [50,"Apply gently","DAB"],
    [51,"Turkey's place","BOWLINGALLEY"],
    ...
    [28,"Garnish for a vodka tonic","LEMONWEDGE"],
    ...
    [20,"Lug","HAUL"],
    [21,"Cavalryman under Teddy Roosevelt during the Spanish-American War","ROUGHRIDER"],
    ...
    [32,"Revolutionary War battle in Boston","BUNKERHILL"],
    ...
    [54,"Hot order with marshmallows","CUPOFCOCOA"],
    [58,"\"Ah, gotcha\"","ISEE"],
    ...
    [17,"In unison","ALLTOGETHER"],
    [19,"Sternward","AFT"],
    [20,"Vote in favor","YEA"],
    [21,"\"Right now!,\" to a surgeon","STAT"],
    [22,"Hoity-toity sort","SNOB"],
    [23,"The idea that matter is composed of small, distinct components","ATOMICTHEORY"],
    ...
    [37,"Common taxi destination","AIRPORTTERMINAL"],
    [41,"Show with many notable alums","SNL"],
    [42,"Oozes","SEEPS"],
    [43,"Late playwright Simon","NEIL"],
    [44,"___ Lama","DALAI"],
    [46,"Without bias","FAIRLY"],
    [48,"Big department store in a mall, e.g.","ANCHORTENANT"],
    [52,"Pepsi, e.g.","COLA"],
    ...
    [11,"One involved with a grand opening?","PIANOTUNER"],
    ...
    [32,"A.L. team with a patriotic color","CHICAGOWHITESOX"],
    ...
    [17,"Like hallucinogenic drugs","MINDBENDING"],
    ...
    [7,"Neither left nor right","MIDDLEOFTHEROAD"],
    ...
    [12,"Jersey","SHIRT"],
    [13,"Long baths","SOAKS"],
    [18,"Calculation using height and weight","BODYMASSINDEX"],
    [23,"Actor Efron","ZAC"],
    [26,"BOGO event","SALE"],
    [30,"Settle on, with \"for\"","OPT"],
    [32,"Place to duke it out","BOXINGRING"],
    [33,"Take advantage of","USE"],
    [35,"Venetian blind part","SLAT"],
    [36,"\"The Loco-Motion\" singer, 1962","LITTLEEVA"],
