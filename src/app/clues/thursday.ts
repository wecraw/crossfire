export const thursdayClues = [
  ...
  // Borrowed from sunday.ts (Sunday NYT puzzles run at roughly Thursday-level
  // difficulty) to relieve Thursday's pool being the tightest bottleneck on the
  // total number of generated chains -- see src/tools/clue-curation-spec.md.
