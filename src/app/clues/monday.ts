export const mondayClues = [ 
    ...
    [16,"Water: Fr.","EAU"],
    [17,"Marine inhabitant that's an animal, not a plant, despite what it's called","SEACUCUMBER"],
    [19,"___ de Triomphe","ARC"],
    [20,"Tiny drink","SIP"],
    [21,"Org. with missions to Mars","NASA"],
    [22,"Put back in the suitcase","REPACK"],
    [24,"43,560 square feet","ONEACRE"],
    [26,"Nightclub","CABARET"],
    [27,"Angry shout to a miscreant","WHYYOULITTLE"],
    ...
    [41,"Sobriquet for Sim\u00f3n Bol\u00edvar","ELLIBERTADOR"],
    ...
    [54,"Observation satellite","EYEINTHESKY"],
    ...
    [2,"Had a home-cooked meal","ATEIN"],
    [3,"Curtain","DRAPE"],
    ...
    [11,"Co-star of TV's \"Maude\"","BEAARTHUR"],
    [12,"Only Spanish city to host the Olympics","BARCELONA"],
    [13,"Facial feature of Disney's Goofy","BUCKTEETH"],
    [18,"Actor Elwes","CARY"],
    [23,"Butter unit","PAT"],
    [25,"Out of kilter","AWRY"],
    [26,"Fed a line to","CUED"],
    [28,"What can barely give a hoot?","OWLET"],
    [29,"Place to store valuables when traveling","HOTELSAFE"],
    [30,"Skills","ABILITIES"],
    [31,"Shawn Carter for Jay-Z and Tracy Morrow for Ice-T","REALNAMES"],
    [35,"Be lenient with","GOEASYON"],
    [36,"Grand Ole ___","OPRY"],
    [37,"The Bronx or Brooklyn, informally","BORO"],
    [39,"Employer of Norah O'Donnell","CBSNEWS"],
    [40,"Place to buy gifts for kids","TOYSHOP"],
    [42,"Ugandan tyrant ___ Amin","IDI"],
    [43,"Makes amends (for)","ATONES"],
    [44,"\"___ mention it!\"","DONT"],
    ...
    [66,"Paving goo","TAR"],
    [67,"Reached the golf course standard","SHOTPAR"],
    [68,"CPR sites","ERS"],
    [1,"Iran-___ (1980s scandal)","CONTRA"],
    [2,"Behind in payments, after \"in\"","ARREARS"],
    [3,"Did intentionally","MEANTTO"],
    ...
    [20,"Start of an overseas telephone number","COUNTRYCODE"],
    ...
    [49,"What a micromanager would like to have","COMPLETECONTROL"],
    [54,"\"Yes, ma ch\u00e9rie\"","OUI"],
    [55,"\"This might be of interest,\" on a memo","FYI"],
    [56,"Fish eggs","ROE"],
    [57,"Georgia's capital: Abbr.","ATL"],
    [58,"Approach respectfully, in modern parlance","COMECORRECT"],
    ...
    [4,"Move so as to hear better, say","LEANIN"],
    [5,"The Empire State Building has 102 of them","STORIES"],
    [6,"Like candles","WAXY"],
    [7,"Smart ___ (wiseacre)","ALEC"],
    [8,"Human ___ Project","GENOME"],
    [9,"Add even more criticism","PILEITON"],
    [10,"Music genre related to punk","EMO"],
    [11,"Place to see the town while painting the town red?","ROOFTOPBAR"],
    [12,"Most populous city in India","MUMBAI"],
    [13,"Symbol starting a Twitter handle","ATSIGN"],
    ...
    [38,"Tending to one's own well-being","SELFCARE"],
    [40,"Instagram upload, for short","PIC"],
    [42,"Bigheadedness","EGO"],
    [43,"[That was a funny one]","LOL"],
    [45,"R&B singer with the hits \"So Sick\" and \"Miss Independent\"","NEYO"],
    ...
    [44,"Many a 1970s remix","DISCOVERSION"],
    ...
    [5,"\"There, there\"","ITSOKAY"],
    [6,"Author Ferber","EDNA"],
    [7,"Suffragist Elizabeth ___ Stanton","CADY"],
    [8,"\"Lemme think ...\"","HMM"],
    [9,"1990s \"Saturday Night Live\" character with a cape","OPERAMAN"],
    [10,"Whirlpool","VORTEX"],
    [11,"Touch","ABUT"],
    ...
    [15,"Postponed for later consideration","LAIDASIDE"],
    [17,"\"You young people go ahead!\"","IMTOOOLDFORTHIS"],
    ...
    [8,"Spat","TIFF"],
    [9,"Last words before being pronounced husband and wife","IDO"],
    [10,"Not drive by oneself to work","CARPOOL"],
    [11,"Cheery greeting","HIHO"],
    [12,"Ares : Greek :: ___ : Norse","ODIN"],
    [13,"Loch ___ monster","NESS"],
    [16,"Patron of sailors","STELMO"],
    ...
    [40,"Scoundrel, in British slang","TOERAG"],
    [41,"What a setting sun dips below","HORIZON"],
    [42,"Urge (on)","EGG"],
    [43,"\"Who'da thunk it?!\"","GEEWHIZ"],
    ...
    [51,"Enthusiastic assent in Mexico","SISI"],
    ...
    [57,"Words before and after \"or not\" in a Shakespeare quote","TOBE"],
    ...
    [9,"Amenity at most hotels and airports","FREEWIFI"],
    ...
    [38,"Jon Bon Jovi or Simon Le Bon","ROCKSTAR"],
    ...
    [14,"Highly classified","TOPSECRET"],
    ...
    [25,"\"Ah, now it's clear\"","ISEE"],
    [27,"Play about Capote","TRU"],
    [30,"Walkie-talkie","TWOWAYRADIO"],
    [35,"Something that may be hidden behind a framed picture","WALLSAFE"],
    [37,"Mixes","STIRS"],
    [38,"Ancient Peruvian","INCA"],
    [39,"Stairs","STEPS"],
    [42,"Eye part with the iris","UVEA"],
    [43,"Odor","SCENT"],
    [45,"Table tennis","PINGPONG"],
    [47,"Rare occurrence on \"Jeopardy!\"","THREEWAYTIE"],
    ...
    [68,"Sign of a beaver's activity, maybe","TREESTUMP"],
    [69,"Exams","TESTS"],
    [70,"\"Alas ...\"","SADLY"],
    [71,"Dove's sound","COO"],
    [1,"\"Halt!\"","STOP"],
    ...
    [41,"Scissor cut","SNIP"],
    [44,"Lipton products","TEABAGS"],
    [46,"\"Hop to it!\"","GETBUSY"],
    [48,"Thin but strong","WIRY"],
    [49,"Most-wanted groups for parties","ALISTS"],
    [53,"Transmitted","SENT"],
    [54,"Aide: Abbr.","ASST"],
    ...
    [21,"Crash into from the back","REAREND"],
    [23,"Greeting in Rio","OLA"],
    [24,"\"Oh yeah? ___ who?\"","SEZ"],
    [26,"Drew up, as plans","DRAFTED"],
    [28,"Brand of foam darts","NERF"],
    [30,"Strikes (out)","XES"],
    [32,"\"Them's fightin' words!\"","ITSWAR"],
    [33,"Loving term for one caring for a sick child","DRMOM"],
    ...
    [3,"What a pitcher might have after a long game","SOREARM"],
    [4,"Suffix with kitchen","ETTE"],
    [5,"\"Oh, also ...,\" in a text","BTW"],
    [6,"Den","LAIR"],
    [7,"Lent support to","AIDED"],
    [8,"More like tired eyes","BLEARIER"],
    [9,"Complete a double play, in baseball slang","TURNTWO"],
    ...
    [40,"\"Well, aren't ___ pair!\"","WEA"],
    [41,"Certain lap dog, familiarly","POM"],
    [42,"Group that meets on the slopes","SKICLUB"],
    [43,"Narrow waterways","STRAITS"],
    [46,"Adamant refusal","ISAIDNO"],
    [47,"Enlivening, with \"up\"","GINNING"],
    [48,"Color manually","HANDDYE"],
    [50,"Hard thing to break","HABIT"],
    [52,"___ and flow","EBB"],
    [55,"Invite to one's penthouse, say","ASKUP"],
    [57,"Peon","SERF"],
    ...
    [16,"Russian \"no\"","NYET"],
    [17,"City where you won't find the Eiffel Tower","PARISTEXAS"],
    ...
    [24,"City where you won't find the Parthenon","ATHENSGEORGIA"],
    ...
    [46,"City where you won't find Virgil's Tomb","NAPLESFLORIDA"],
    [50,"Pal of Jerry on \"Seinfeld\"","ELAINE"],
    [51,"Driveway material","TAR"],
    [52,"QB successes","TDS"],
    [55,"Excessive drinking or gambling","VICE"],
    [56,"City where you won't find the El Greco Museum","TOLEDOOHIO"],
    ...
    [25,"Network for watching Congress","CSPAN"],
    [26,"Accustom","INURE"],
    ...
    [39,"State sch. southeast of Columbus","OHIOU"],
    ...
    [18,"\"Crossing my fingers!\"","IHOPE"],
    [19,"Squiggly mark in \"pi\u00f1ata\"","TILDE"],
    [20,"Earl ___ tea","GREY"],
    [21,"2001 Tom Cruise thriller","VANILLASKY"],
    [23,"Some rides from the airport, nowadays","UBERS"],
    [24,"Leave out","OMIT"],
    [25,"James who sang \"At Last\"","ETTA"],
    [27,"Nickname for former N.B.A. star Darryl Dawkins","CHOCOLATETHUNDER"],
    ...
    [2,"Funny (or sarcastic) joke response","HAHA"],
    [3,"Japanese noodle type","UDON"],
    [4,"Pudding ingredient","TAPIOCA"],
    [5,"Patron for sailors","STELMO"],
    [6,"Friendly response to \"Do you mind?\"","NOTATALL"],
    [7,"Hertz rival","AVIS"],
    [8,"___ Road, route for Marco Polo","SILK"],
    [9,"\"Still ...\"","ANDYET"],
    [10,"Director Spike","LEE"],
    [11,"Beginning of the universe","BIGBANG"],
    [12,"Days of ___","YORE"],
    [13,"One with a debt","OWER"],
    [14,"Large inlets","BAYS"],
    [22,"Rapper ___ Wayne","LIL"],
    [23,"Maneuver upon missing a GPS instruction","UTURN"],
    ...
    [46,"Nickname","MONIKER"],
    [48,"Pacific weather phenomenon","ELNINO"],
    [49,"Unfortunate crowd reaction to a performer","BOO"],
    [50,"[I don't know the words to this part]","LALALA"],
    ...
    [9,"[Oh, well]","SIGH"],
    [13,"Things that go off when there's danger","ALARMBELLS"],
    [16,"Other: Sp.","OTRO"],
    [17,"Where to go for a fill-up","GASSTATION"],
    [18,"Mets' venue before Citi Field","SHEA"],
    [19,"Regarding","ASTO"],
    [20,"___ San Lucas (Mexican resort city)","CABO"],
    [21,"Member of a tough crowd, say","BOOER"],
    [22,"Firm place to plant your feet","SOLIDGROUND"],
    [24,"\"That sounds fun to me!\"","IMDOWN"],
    ...
    [9,"\"Leaving already?\"","SOSOON"],
    [10,"\"That seemed right to me, too\"","ITHOUGHTSO"],
    ...
    [52,"\"Huh, funny running into you!\"","OHHI"],
    ...
    [17,"Arkansas's capital","LITTLEROCK"],
    ...
    [25,"Derri\u00e8re","TUSH"],
    [26,"Bicolor cookies also called half-moons","BLACKANDWHITES"],
    ...
    [42,"Final practice before the big show","DRESSREHEARSAL"],
    ...
    [27,"Circular food item that may come in a 16\" square box","LARGEPIZZA"],
    ...
    [19,"Major-league team from the Motor City","DETROITTIGERS"],
    [22,"Frozen H2O","ICE"],
    [23,"Female deer","DOE"],
    [24,"Not quite right","AMISS"],
    [27,"Start of a tennis rally","SERVE"],
    [29,"\"Hold your horses!\"","SITTIGHT"],
    [32,"Variety","ILK"],
    [34,"Prefix often associated with green","ECO"],
    [35,"\"You there!\"","HEY"],
    [36,"Ballot for candidates of more than one party","SPLITTICKET"],
    [40,"One that gives a hoot?","OWL"],
    [42,"Humor","WIT"],
    [43,"Container at a beer bash","KEG"],
    [44,"Number of minutes on hold before getting a customer representative","WAITTIME"],
    [47,"Greek I's","IOTAS"],
    ...
    [51,"Dorothy's footwear in \"The Wizard of Oz\"","RUBYSLIPPERS"],
    [57,"White-faced","ASHEN"],
    [60,"Bit of cookware","PAN"],
    [61,"Biz bigwig","EXEC"],
    [62,"What follows Thanksgiving","BLACKFRIDAY"],
    ...
    [3,"Don Juan sort","LATINLOVER"],
    [4,"Bro's sibling","SIS"],
    [5,"Network for political junkies","CSPAN"],
    [6,"Big name in toothbrushes","ORALB"],
    [7,"Pinker in the middle, say","RARER"],
    [8,"Always, in poetry","EER"],
    ...
    [30,"Start of a newsboy's cry","EXTRAEXTRA"],
    ...
    [44,"\"I'm up for doing the job!\"","SURECAN"],
    ...
    [23,"One going for a stroll among urban greenery","PARKVISITOR"],
    [26,"\"Quit wasting time!\"","GETBUSY"],
    [30,"Abba of Israel","EBAN"],
    [31,"Even a little","ATALL"],
    [32,"___-haw","HEE"],
    [33,"Plumbing woe","LEAK"],
    [37,"Official hearing a case","TRIALCOURTJUDGE"],
    [41,"Fish that wriggle","EELS"],
    [42,"What's dropped off a cigarette","ASH"],
    [43,"Words of empathy","ICARE"],
    [44,"Weights that may be \"short\" or \"long\"","TONS"],
    [46,"Tevye's occupation in \"Fiddler on the Roof\"","MILKMAN"],
    [48,"Herbie Hancock or Chick Corea","JAZZPIANIST"],
    ...
    [10,"\"How fortunate for us!\"","WEREINLUCK"],
    ...
    [17,"Tennis with dad?","POPSINGLES"],
    [20,"Messy meal for pigs","SLOP"],
    [21,"Motorists' org.","AAA"],
    [22,"\"Not in a million years!\"","NEVER"],
    [23,"Losing tennis player's prayer?","GIMMEABREAK"],
    [26,"In a trite way","BANALLY"],
    [30,"Exam for a future atty.","LSAT"],
    [31,"Wonderland girl","ALICE"],
    [32,"\"___ making myself clear?\"","AMI"],
    [33,"Guzzle down","CHUG"],
    [37,"Dislike for tennis?","CONTEMPTOFCOURT"],
    [41,"Sharp as a tack","KEEN"],
    [42,"ExxonMobil business","OIL"],
    [43,"Jargon","LINGO"],
    [44,"Famous ___ (cookie brand)","AMOS"],
    [46,"Things for cleaning dishes","SPONGES"],
    [48,"\"Wow, no wonder you're playing such great tennis!\"?","WHATARACKET"],
    [52,"Overdo, as a stage role","HAMUP"],
    [53,"Assistance","AID"],
    [54,"\"Good heavens!\"","OHMY"],
    [58,"Letter-shaped beam","IBAR"],
    [59,"Lose every set of a tennis match 6-0?","FALLINLOVE"],
    [62,"Ship of 1492","NINA"],
    [63,"\"___ be over soon\"","ITLL"],
    [64,"Take home from the shelter, say","ADOPT"],
    [65,"And others: Abbr.","ETAL"],
    ...
    [9,"\"___ Miz\"","LES"],
    [10,"Arcade game instruction before playing","INSERTCOIN"],
    [11,"Depart","LEAVE"],
    ...
    [25,"\"You wish!\"","ASIF"],
    [27,"___ vera","ALOE"],
    [29,"\"Pretend nothing just happened\"","ACTNATURAL"],
    ...
    [18,"Start of a nursery rhyme on a farm","BAABAABLACKSHEEP"],
    ...
    [68,"Didn't venture out for dinner","ATEIN"],
    ...
    [36,"Pork dish of Southern cuisine","NECKBONES"],
    [39,"\"How goes it?,\" in Spanish","COMOESTAS"],
    ...
    [9,"King Cole was a \"merry\" one","OLDSOUL"],
    [10,"Comment made when itching to leave a dull party","MYITSLATE"],
    ...
    [45,"Nearest target for a bowler","ONEPIN"],
    ...
    [17,"Traveled by subway?","WENTDOWNTHETUBE"],
    [20,"Mexican mister","SENOR"],
    [21,"Seat at the bar","STOOL"],
    [22,"___ v. Wade","ROE"],
    [23,"Magnum ___ (greatest work)","OPUS"],
    [25,"Like a recovering hosp. patient, perhaps","POSTOP"],
    [27,"\"Would you call the elevator for me?\"","CANIGETALIFT"],
    ...
    [48,"\"Hand me a flashlight\"?","PASSTHETORCH"],
    [51,"Admits, as an offense","COPSTO"],
    ...
    [63,"Use French fries as legal tender?","CASHINONESCHIPS"],
    ...
    [5,"Vow before a judge","IDO"],
    [6,"The latest","NEWS"],
    [7,"Jargon","CANT"],
    [8,"Cher, e.g., voicewise","ALTO"],
    [9,"Remove, as a sticker","PEELOFF"],
    ...
    [30,"Nail the test","ACEIT"],
    [31,"Dog walker's need","LEASH"],
    [35,"Reason some people move to the Cayman Islands","TAXRELIEF"],
    ...
    [52,"Alternative to Chicago's Midway","OHARE"],
    ...
    [3,"Inelegant problem-solving technique","BRUTEFORCE"],
    [4,"Nincompoop","ASS"],
    [5,"One of the Twin Cities","STPAUL"],
    [6,"Cups, saucers, pot, etc.","TEASET"],
    ...
    [31,"Kind of vehicle to take off-road","ALLTERRAIN"],
    ...
    [39,"Pay-___-view","PER"],
    [42,"Words spoken after a big raise?","IFOLD"],
    [43,"\"Yu-u-uck!\"","EWW"],
    ...
    [52,"Three-time A.L. M.V.P. (2003, 2005 and 2007), informally","AROD"],
    [53,"Miles away","AFAR"],
    ...
    [51,"Rock drummer whose last name is the same as his band","ALEXVANHALEN"],
    [55,"Gift recipient","DONEE"],
    [56,"Eggs for fertilization","OVA"],
    [57,"Petri dish medium","AGAR"],
    [61,"Hour after midnight","ONE"],
    [62,"Accessing, as a password-restricted website","LOGGINGINTO"],
    ...
    [1,"___ funny (genuinely humorous)","HAHA"],
    [2,"\"You're on!\"","DEAL"],
    ...
    [10,"Charge to get cash from a bank, say","ATMFEE"],
    [11,"\"Absolutely, positively not!\"","NOSIREEBOB"],
    ...
    [30,"Body of water between France and Switzerland","LAKEGENEVA"],
    ...
    [19,"Asterisk","STAR"],
    [20,"Flower of the tree Prunus mume","PLUMBLOSSOM"],
    ...
    [33,"Bringer of cold weather","NORTHWIND"],
    [37,"___-hole (place to secrete oneself)","HIDEY"],
    [38,"Word before whiz","GEE"],
    [39,"Winged beast on the Welsh flag","REDDRAGON"],
    ...
    [27,"Miles away","AFAR"],
    [28,"Impulse","URGE"],
    [29,"Comment made with a pat on the back","GOODFORYOU"],
    [30,"Commotions","TODOS"],
    ...
    [43,"Rampaging","ONATEAR"],
    [45,"Receptors for solar energy","PANELS"],
    [46,"Complaints","BEEFS"],
    [47,"\"... well, never mind then\"","ORNOT"],
    ...
    [9,"Like a two-position electrical switch","ONOFF"],
    ...
    [28,"Latin list lopper, in brief","ETAL"],
    [30,"Whole lot","SLEW"],
    ...
    [49,"Get ready for production, as a factory","TOOLUP"],
    [51,"Satirical work, like \"Bored of the Rings\"","PARODY"],
    [53,"Homes made of sun-dried bricks","ADOBES"],
    [54,"\"Madama Butterfly\" dress","KIMONO"],
    [55,"Response to \"Who, me?\"","YESYOU"],
    [57,"Airport for a Bull or a Bear","OHARE"],
    [58,"Toys on strings","YOYOS"],
    ...
    [18,"Greets from across the way, say","WAVESHELLO"],
    [20,"Lollygags","LOAFS"],
    [22,"That is to say, in Latin","IDEST"],
    [23,"Casually browse online","SURFTHENET"],
    ...
    [35,"Time of lament","SADDAY"],
    [36,"Spends moolah","SHELLSOUTCASH"],
    [39,"Little VW","BEETLE"],
    ...
    [46,"___ ID","USER"],
    [47,"Demonstrates some sleight of hand","PALMSCARDS"],
    [51,"Should arrive any minute now","ISDUE"],
    ...
    [1,"Financial ctr. in Manhattan","WALLST"],
    [2,"\"Most definitely, monsieur!\"","OUIOUI"],
    [3,"Feature of a Las Vegas \"bandit\"","ONEARM"],
    ...
    [10,"Low-calorie drinks","DIETSODAS"],
    [11,"Ha-ha, online","LOL"],
    [12,"Sick","ILL"],
    ...
    [33,"\"Stupid\" segments on old David Letterman shows","PETTRICKS"],
    [34,"\"We need help!\"","SOS"],
    ...
    [52,"The Beatles' \"___ Leaving Home\"","SHES"],
    ...
    [25,"Triple Crown winner of 1977","SEATTLESLEW"],
    ...
    [56,"Kind of question you have a 50% chance of guessing correctly","YESNO"],
    [57,"German industrial city","ESSEN"],
    [61,"F.B.I. agent, in old slang","GMAN"],
    [63,"___ as a fox","SLY"],
    [65,"In the style of, in cookery","ALA"],
    [1,"Aware, in a modern way","WOKE"],
    [5,"Idris ___, People's 2018 Sexiest Man Alive","ELBA"],
    [9,"Abyss","CHASM"],
    [14,"\"Man, I'm sorry to hear!\"","OHNO"],
    [15,"Nursery rhyme word repeated before \"go away\"","RAIN"],
    [16,"\"Social contract\" philosopher John","LOCKE"],
    [17,"Dachshund","WIENERDOG"],
    [19,"Totally wipe out","EATIT"],
    [20,"Plant, as seeds","SOW"],
    [21,"Our sun","SOL"],
    [22,"Dress in Delhi","SARI"],
    [23,"Copies of movies submitted to critics prior to release","SCREENERDVDS"],
    [28,"___ mark (#)","HASH"],
    [30,"\"Mazel ___!\"","TOV"],
    [31,"Witnessed","SEEN"],
    [32,"Partner at a table for two","DINNERDATE"],
    ...
    [42,"Times when everything goes perfectly","BANNERDAYS"],
    [45,"Ambulance crew, for short","EMTS"],
    [47,"Words exchanged at an altar","IDO"],
    [48,"Fellas","GUYS"],
    [49,"Genetically engineered, highly selective medical treatment","DESIGNERDRUG"],
    ...
    [11,"Running around during recess, e.g.","ACTIVEPLAY"],
    ...
    [28,"Plea from a fugitive","HIDEME"],
    [29,"Announcer's cry after a successful field goal attempt","ANDITSGOOD"],
    [32,"Handed (out)","DOLED"],
    ...
    [42,"Web address","URL"],
    [43,"Archipelago forming the southernmost part of the continental U.S.","FLORIDAKEYS"],
    [47,"Gloomy pal of Winnie-the-Pooh","EEYORE"],
    [49,"Auditioner's goal","ROLE"],
    [50,"Newborn horses","FOALS"],
    [53,"Run for a long football pass","GODEEP"],
    [57,"Singer Edith known as \"The Little Sparrow\"","PIAF"],
    [60,"Disappear","VANISH"],
    [62,"\"Despicable Me\" character voiced by Steve Carell","GRU"],
    [63,"Member of an N.F.L. team transplanted to Los Angeles in 2017","SANDIEGOCHARGER"],
    [66,"\"Could you, would you, with ___?\" (Dr. Seuss line)","AGOAT"],
    ...
    [18,"Leaning","ATILT"],
    [19,"Canine collar dangler","IDTAG"],
    [24,"Lummoxes","OAFS"],
    [26,"WSW's opposite","ENE"],
    [28,"Letter you don't pronounce in \"jeopardy\" and \"leopard\"","THEO"],
    ...
    [45,"Annual Westminster event","DOGSHOW"],
    [46,"Hawaiian greeting","ALOHA"],
    [48,"Time of lackluster performance","OFFDAY"],
    ...
    [64,"\"___ never too late to learn\"","ITS"],
    ...
    [16,"Cinnamon buns and such","BREAKFASTROLLS"],
    ...
    [23,"\"Hmm, that's not good ...\"","OHDEAR"],
    [25,"Slight coloring","TINT"],
    [27,"Slight downturn","DIP"],
    [28,"Modern pet name","BAE"],
    [29,"Cyclical paradox discussed in \"G\u00f6del, Escher, Bach\"","STRANGELOOP"],
    ...
    [48,"Onetime TV political drama set in Washington","THEWESTWING"],
    [52,"\"Now I get it!\"","AHA"],
    [53,"Tit for ___","TAT"],
    ...
    [41,"Hypothetical musings","WHATIFS"],
    [42,"\"Now, work!\"","GETONIT"],
    [43,"Slightly","AWEEBIT"],
    [45,"Purr-son who loves her pets?","CATLADY"],
    ...
    [18,"It may include a backpack, boots and a water bottle","HIKINGGEAR"],
    [20,"Slightly off","AMISS"],
    [22,"Gyllenhaal of \"Brokeback Mountain\"","JAKE"],
    [23,"Decompose","ROT"],
    [24,"Japanese verse with 17 syllables","HAIKUPOEM"],
    ...
    [39,"Expensive, as a product line","HIGHEND"],
    [41,"Seven Dwarfs' cry as off to work they go","HEIGHHO"],
    ...
    [52,"Supermodel and longtime \"Project Runway\" host","HEIDIKLUM"],
    [56,"Place for a mud bath","SPA"],
    [58,"Appearance","MIEN"],
    [60,"\"Swell!\"","NEATO"],
    [61,"Toyota Prius and Honda Insight","HYBRIDCARS"],
    ...
    [1,"Doctor's request during a physical","SAYAH"],
    [2,"Scent","AROMA"],
    ...
    [26,"Some newspaper essays","OPEDS"],
    ...
    [59,"Vows exchanged at the altar","IDOS"],
    ...
    [20,"Classic fund-raising event","BAKESALE"],
    [22,"1950s presidential inits.","DDE"],
    [23,"Writer/illustrator Silverstein","SHEL"],
    [24,"Premium theater spot","BOXSEAT"],
    ...
    [45,"Committed accounting fraud","COOKEDTHEBOOKS"],
    ...
    [3,"What a revolution may usher in","NEWERA"],
    ...
    [10,"Md. home to the U.S. Cyber Command","FTMEADE"],
    ...
    [17,"Period dominated by the likes of Dan Rather and Peter Jennings?","ANCHORAGE"],
    [19,"Stop competing as an amateur","GOPRO"],
    [20,"Like dry, clumpy mud","CAKED"],
    [21,"Cool, in '90s slang","PHAT"],
    [23,"Blacken, as by fire","CHAR"],
    [24,"Joan who sang at Woodstock","BAEZ"],
    [26,"Period when every car was a junker?","WRECKAGE"],
    [28,"Hairless","BALD"],
    ...
    [39,"Period known for its 007 movies?","BONDAGE"],
    [41,"Period of fuzzy sweaters?","PILLAGE"],
    [43,"So last year","OLD"],
    ...
    [50,"Period when tribute bands thrived?","COVERAGE"],
    [54,"Flees","LAMS"],
    ...
    [64,"Period when psychiatrists ruled?","SHRINKAGE"],
    ...
    [35,"Mimicked","APED"],
    [36,"Campus sanctuary, in modern parlance","SAFESPACE"],
    [37,"Taj Mahal locale","AGRA"],
    [38,"Lowly worker","PEON"],
    [40,"Food-thickening agent","AGAR"],
    [42,"Legislator","LAWMAKER"],
    [45,"Specialty bakery","PIESHOP"],
    [47,"Home mixology station","WETBAR"],
    [50,"Pulls an all-nighter, say","CRAMS"],
    [51,"Prepare for a bodybuilding contest","OILUP"],
    ...
    [65,"\"___ Always Sunny in Philadelphia\"","ITS"],
    ...
    [17,"Adjudicator of an attempt at a physical feat, say","GUINNESSOFFICIAL"],
    [20,"Early birds?","EGGS"],
    [21,"Eldest of the von Trapp children","LIESL"],
    [22,"What polytheists believe in","GODS"],
    [23,"\"Let's do it!\"","IMIN"],
    [25,"Hole ___ (golf feat)","INONE"],
    [27,"Vocalist who doesn't tour","STUDIOSINGER"],
    ...
    [11,"June observance commemorating the Stonewall Riots","PRIDEMONTH"],
    ...
    [50,"Atmosphere","AURA"],
    [52,"Question to a betrayer","ETTU"],
    ...
    [10,"\"Oh yeah? You and what army?\"","SEZWHO"],
    ...
    [25,"\"Yeah, sure!\"","IBET"],
    [26,"Make again, as hotel plans","REBOOK"],
    [28,"Brambles","BRIARS"],
    ...
    [46,"Marching synchronously","INSTEP"],
    [49,"Plant deeply","EMBED"],
    [50,"\"Too rich for my blood\"","IFOLD"],
    [51,"Cabs","TAXIS"],
    ...
    [56,"End in ___ (be deadlocked)","ATIE"],
    [60,"Little chuckle","HEH"],
    [61,"Abbr. on a food label","RDA"],
    [1,"Very bottom","NADIR"],
    [6,"[OMG!]","GASP"],
    [10,"Super Mario Bros. console, for short","NES"],
    [13,"___ trump (bridge bid)","ONENO"],
    [14,"Killer whales","ORCAS"],
    [16,"Be ___ loss for words","ATA"],
    [17,"Reason to raid the fridge","SNACKATTACK"],
    [19,"Biol. or chem.","SCI"],
    ...
    [28,"Regret","RUE"],
    [29,"No longer astray","BACKONTRACK"],
    [32,"Tony winner Menzel","IDINA"],
    [34,"In pieces","APART"],
    [35,"Batter's grip-enhancing goo","PINETAR"],
    [38,"Encourages","SPURSON"],
    [42,"Romanced, in a way","WINED"],
    [44,"\"Keen!\"","NEATO"],
    [45,"1986 Keith Haring antidrug mural","CRACKISWACK"],
    ...
    [11,"And so on, and so on, for short","ETCETC"],
    [12,"Assented","SAIDOK"],
    ...
    [33,"Part of many a showcase on \"The Price Is Right\"","NEWCAR"],
    ...
    [37,"Movie clip where the grips, boom operator and gaffer all appear?","CREWCUT"],
    [39,"HBO rival","SHO"],
    ...
    [47,"Finalize the music for the movie?","SETTLEASCORE"],
    [51,"\"There, there ...\"","ITSOK"],
    [52,"Bangs on the head?","HAIR"],
    [53,"Tasseled hat","FEZ"],
    [56,"Make headway","GAIN"],
    [57,"Redo of a movie scene?","DOUBLETAKE"],
    ...
    [27,"Have an invisible footprint","LEAVENOTRACE"],
    [32,"Whimper","MEWL"],
    ...
    [67,"Newspaper opinion pieces","OPEDS"],
    [68,"Optimistic","ROSY"],
    ...
    [28,"Billy Idol hit that starts \"Hey little sister, what have you done?\"","WHITEWEDDING"],
    ...
    [44,"Vegetarian spaghetti topper","MUSHROOMBALL"],
    ...
    [19,"Message on a giant foam finger","WERENUMBERONE"],
    [22,"Chem. or biol.","SCI"],
    ...
    [35,"1999 rom-com with Freddie Prinze Jr. and Rachael Leigh Cook","SHESALLTHAT"],
    [39,"Release, as a new album","DROP"],
    [41,"Less than 90\u00b0, as an angle","ACUTE"],
    [42,"\"Livin' la ___ Loca\"","VIDA"],
    [43,"\"Anything Goes\" song","YOURETHETOP"],
    ...
    [57,"Kellogg's Frosted Flakes slogan","THEYREGRRREAT"],
    ...
    [10,"Award-winning sports journalist who went from ESPN to The Atlantic","JEMELEHILL"],
    [11,"Exist","ARE"],
    [12,"Went for office","RAN"],
    [14,"Signature accessory of Carmen Miranda","FRUITHAT"],
    [20,"TV drama with spinoffs set in Los Angeles and New Orleans","NCIS"],
    [21,"Down Under gemstone","OPAL"],
    [25,"24 hours from now","INADAY"],
    [26,"Subject of a will","ESTATE"],
    [27,"\"Still ...\"","ANDYET"],
    [28,"Well-muscled","STRONG"],
    [29,"\"Don't hesitate to say what you want\"","SHOUTITOUT"],
