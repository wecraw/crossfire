export const fridayClues = [
    ...
    [15,"Popular orders at beachside bars","BAHAMAMAMAS"],
    [16,"U-Haul option","VAN"],
    [17,"Comment before indulging","ICANTRESIST"],
    ...
    [53,"Way of Life?","CEREALAISLE"],
    [55,"Stir","ADO"],
    [56,"Helen of Troy, e.g.","DEMIGODDESS"],
    [57,"Lip","RIM"],
    [58,"Some reference works in newsrooms","STYLEGUIDES"],
    ...
    [5,"Qts. and pts.","AMTS"],
    [6,"Way out","FAR"],
    [7,"Onetime Food Network show featuring Creole and Cajun cuisine","EMERILLIVE"],
    [8,"Kind of jar","MASON"],
    ...
    [17,"Olympics haul of fame?","GOLDMEDALS"],
    ...
    [25,"Skill for a good physician","BEDSIDEMANNER"],
    [29,"Heritage","ROOTS"],
    ...
    [39,"Equanimity","POISE"],
    [40,"Accept things as they are","GOWITHTHEFLOW"],
    ...
    [6,"People-powered vehicles","PADDLEBOATS"],
    ...
    [29,"Floats are often made with them","ROOTBEERS"],
    ...
    [5,"Bird named for its black-and-white markings","ZEBRAFINCH"],
    ...
    [18,"Cocktail made from peach schnapps and orange juice","FUZZYNAVEL"],
    [19,"Track event","TROT"],
    ...
    [52,"Was charming?","CASTASPELL"],
    [56,"Queens stadium eponym","ASHE"],
    [57,"Body of water between two locks of the Erie Canal","ONEIDALAKE"],
    [58,"The Big Bad Wolf, in old cartoons","ZEKE"],
    [59,"Reason for going out a lot?","NARCOLEPSY"],
    [60,"Fervor","ZEAL"],
    [1,"Pool surface","FELT"],
    [2,"Sole supporter?","ODOREATER"],
    [3,"Item sold at Burger King but not at most McDonald's","ONIONRING"],
    [4,"Person tasked with locking up","LASTTOLEAVE"],
    ...
    [27,"So on and so forth","ALLTHATJAZZ"],
    [28,"Starch-producing palm tree","SAGO"],
    [29,"Oreo ___","THINS"],
    [31,"Small fruit high in pectin","CRABAPPLE"],
    [32,"\"Lemme look!\"","IWANNASEE"],
    ...
    [54,"Foofaraw","ADO"],
    [55,"___ soda","SAL"],
    [1,"Rock and Roll Hall of Fame band led by Iggy Pop","THESTOOGES"],
    [11,"Intermediate gait","TROT"],
    [15,"Do thumb traveling?","HITCHARIDE"],
    [16,"Someone who's well-off","HAVE"],
    [17,"\"Well, then ...\"","INTHATCASE"],
    [18,"Balanced","EVEN"],
    [21,"\"No you ___!\"","ARENT"],
    [22,"Tankerful","OIL"],
    ...
    [32,"Some road trip entertainment","AUDIOBOOKS"],
    ...
    [60,"Corellia, to Han Solo","HOMEPLANET"],
    [63,"Roman counterpart of the Greek goddess Selene","LUNA"],
    [64,"\"Flash Gordon\" genre","SPACEOPERA"],
    [65,"Trousers part","SEAT"],
    [66,"Driving distractions","TEXTALERTS"],
    [1,"No, not that!","THIS"],
    [2,"Very small amount","HINT"],
    [3,"___ Candy, friend of Wonder Woman","ETTA"],
    [4,"Thought experiment in quantum physics","SCHRODINGERSCAT"],
    ...
    [10,"Date","SEE"],
    [11,"\"You're doomed!\"","THEREISNOESCAPE"],
    ...
    [33,"Notoriously spoiled sort","TRUSTFUNDBABY"],
    [36,"Figures in the Edda","NORSEDEITIES"],
    ...
    [20,"Certain adopted pet","RESCUEDOG"],
    [22,"Salon jobs","COIFS"],
    ...
    [16,"Total","RUNTO"],
    [17,"What the British call a station wagon","ESTATECAR"],
    ...
    [29,"Trampled","TREADEDON"],
    [30,"Brown family member","EARTHTONE"],
    ...
    [17,"Acted cheekily (in two senses?)","STOLEAKISS"],
    ...
    [66,"Appear","SEEM"],
    [67,"Sticker in a restaurant window","ZAGATRATED"],
    [68,"Beau ideal","HERO"],
    [69,"Pen name of Ruth Crowley and Eppie Lederer","ANNLANDERS"],
    [1,"Wallops","PASTES"],
    [2,"Place for dogs to rest","OTTOMAN"],
    [3,"Tabloid question next to two people in the same outfit","WHOWOREITBETTER"],
    [4,"Wing","ELL"],
    ...
    [11,"\"Tsk, tsk!\"","SHAME"],
    [12,"\"Can you say more about that?\"","CARETOELABORATE"],
    ...
    [15,"Alternative to Mountain Dew","MELLOYELLO"],
    [16,"Caption on breaking news","LIVE"],
    [17,"One who might cackle \"Mwa-ha-ha-ha!\"","EVILGENIUS"],
    ...
    [64,"Question always best answered \"no\"","DOILOOKFAT"],
    [65,"Springs","SPAS"],
    [66,"Previews","SNEAKPEEKS"],
    ...
    [5,"Genre of the \"Serial\" podcast","TRUECRIME"],
    ...
    [33,"Creamier alternative to a cold brew","ICEDLATTE"],
    [35,"Ease","ALLAY"],
    ...
    [55,"Sweetie","BAE"],
    [1,"One who takes stock","CATTLETHIEF"],
    ...
    [53,"Director of two Best Picture-nominated films of the 2010s","GRETAGERWIG"],
    [55,"Issa of comedy","RAE"],
    [56,"\"Unforgettable ... With Love\" Grammy recipient","NATALIECOLE"],
    [57,"Author","PEN"],
    ...
    [12,"1973 Jim Croce hit","IGOTANAME"],
    [13,"Rage quitter, maybe","SORELOSER"],
    ...
    [30,"Powerful spirits","AQUAVITAE"],
    [31,"British P.M.'s residence, informally","NUMBERTEN"],
    ...
    [17,"Fifth wheel","SPARETIRE"],
    [18,"Small protuberance","KNURL"],
    [19,"\"Ingredient\" of success","SECRETSAUCE"],
    ...
    [51,"Primer finish","ZISFORZEBRA"],
    [54,"\"Pretty, pretty please?\"","CANTI"],
    [56,"Grueling grillings","ORALEXAMS"],
    [57,"Trim","ADORN"],
    [58,"Process by which neutrinos are produced","BETADECAY"],
    ...
    [30,"\"So much for my theory\"","IGUESSNOT"],
    ...
    [13,"Northernmost land in the Inner Hebrides","ISLEOFSKYE"],
    [16,"Prefix with nautical","AERO"],
    [17,"Cut-and-paste tool for language learners","GOOGLETRANSLATE"],
    [19,"Piece of sensitive info, for short","SSN"],
    [20,"Average","MEAN"],
    [21,"Name that sounds like two of its letters","ELLY"],
    [22,"Garden figure","GNOME"],
    [25,"Stoke","FUEL"],
    [26,"What a fitness coach likely leads","ACTIVELIFESTYLE"],
    ...
    [41,"In-N-Out Burger's \"Animal Style\" burgers and fries, e.g.","SECRETMENUITEMS"],
    [44,"[Gulp!]","OHNO"],
    [45,"Plus","ASSET"],
    [46,"Part of a church chorus","AMEN"],
    [47,"Theravada or Mahayana vis-\u00e0-vis Buddhism","SECT"],
    [49,"Japanese assent","HAI"],
    [52,"Like some headphones","NOISECANCELLING"],
    [56,"People of northeastern Canada","INNU"],
    [57,"Eagerly starting, as one's work","DIVINGINTO"],
    ...
    [1,"Gluttons","PIGS"],
    [2,"Those: Sp.","ESOS"],
    [3,"Well overdue","ALONGTIMECOMING"],
    [4,"Powder holder","KEG"],
    ...
    [10,"Out of the ordinary","REALLYSOMETHING"],
    [11,"Pretentious, in a way","ARTY"],
    [14,"Queer designation","FEMME"],
    [15,"Instrument played by a pannist","STEELDRUM"],
    ...
    [62,"Star student's goal","APLUSAVERAGE"],
    ...
    [9,"Stockpile","HOARD"],
    [14,"Gaze at, as someone's eyes","STAREINTO"],
    [15,"Tool used while on foot","EDGER"],
    [16,"Be heedful","LENDANEAR"],
    ...
    [35,"So-called \"Grandmother of Europe,\" born 5/24/1819","QUEENVICTORIA"],
    [39,"Boot","OUST"],
    ...
    [63,"Opening of an account","ASIRECALL"],
    ...
    [18,"Cop's station in England","POLICEBOX"],
    [20,"Sweet farewell","KISSONTHECHEEK"],
    ...
    [50,"Beauty lesson","MAKEUPTUTORIAL"],
    [54,"One for whom a flash in the pan is a good thing","GOLDMINER"],
    ...
    [10,"Precisely","TOBEEXACT"],
    [11,"Monitors","LOOKSINON"],
    [12,"___ bike","BMX"],
    ...
    [29,"Transgender rights activist and best-selling author of \"Redefining Realness\"","JANETMOCK"],
    ...
    [23,"Shrewdness","GOODSENSE"],
    [26,"Brother of the Wild West","EARP"],
    [27,"Laugh hysterically","ROAR"],
    [28,"One of the Brady kids","GREG"],
    [30,"Summer broadcast for ESPN","MAJORLEAGUEGAME"],
    [37,"What many doctors and lawyers work in","PRIVATEPRACTICE"],
    [38,"It's sanctioned by a \"G\"","GENERALAUDIENCE"],
    ...
    [6,"Bad way to be left","ATTHEALTAR"],
    ...
    [12,"1991 Kenneth Branagh film about reincarnation","DEADAGAIN"],
    [13,"Diner","EATER"],
    ...
    [15,"\"Well, what do you know?!\"","IMAGINETHAT"],
    [16,"Accessory for Miss Piggy","BOA"],
    [17,"Six-time Grammy winner who is half of the group Gnarls Barkley","DANGERMOUSE"],
    ...
    [49,"Type unprofessionally","HUNTANDPECK"],
    [52,"Sleep study acronym","REM"],
    [53,"\"Hallelujah!\"","ITSAMIRACLE"],
    [54,"Change the locks?","DYE"],
    [55,"\"Brilliant!\"","THATSGENIUS"],
    [1,"Extensive","WIDE"],
    ...
    [11,"Led","STEERED"],
    [12,"Supercilious","ABOVEITALL"],
    [13,"Spit spot","ROTISSERIE"],
    [14,"Become legally certified","PASSTHEBAR"],
    [22,"\"My baby at my breast,\" to Shakespeare's Cleopatra","ASP"],
    [23,"Boba ___, \"Star Wars\" bounty hunter","FETT"],
    [24,"Sounds of failure","THUDS"],
    [25,"Leafy vegetable related to a beet","SWISSCHARD"],
    [26,"1974 Abba hit","HONEYHONEY"],
    [27,"Mazurka meter","TRIPLETIME"],
    ...
    [1,"Dress down","CHIDE"],
    [6,"El Chapo, notably","CRIMEBOSS"],
    [15,"Caravan destinations","OASES"],
    [16,"Western vacation spot","DUDERANCH"],
    [17,"Split tickets?","STUBS"],
    [18,"1924 to 1953","STALINERA"],
    ...
    [55,"Sight in many a Japanese restaurant","TATAMIMAT"],
    [59,"Downton Abbey, e.g.","MANOR"],
    [60,"Skating site","ICEPALACE"],
    [61,"Growth on buoys","ALGAE"],
    [62,"Took courses under pressure","STRESSATE"],
    [63,"Core group?","SEEDS"],
    ...
    [15,"Green land","EMERALDISLE"],
    [16,"Quick turnaround","UIE"],
    [17,"Youngest French president before Macron","NAPOLEONIII"],
    ...
    [55,"The world's largest one straddles the border of France and Switzerland","ATOMSMASHER"],
    [62,"Suffix in biology","OME"],
    [63,"Mnemonic device","AIDEMEMOIRE"],
    [64,"Inexpensive beer, informally","PBR"],
    [65,"Social hierarchy that rejects individualism","CASTESYSTEM"],
    [1,"Motherly sort","HEN"],
    ...
    [12,"Low-percentage chance to win","OUTSIDESHOT"],
    [13,"Cocktail with gin and grapefruit","PINKMARTINI"],
    [14,"Will might change them","TENSES"],
    [21,"Success story out of Sunnyvale, Calif.","ATARI"],
    [22,"Spotted","SEEN"],
    [23,"Double cheeseburger with extra bacon, e.g.","CALORIEBOMB"],
    [24,"One end of the Erie Canal","HUDSONRIVER"],
    ...
    [17,"Collection consisting of four plates, four saucers, four bowls, etc.","STARTERSET"],
    ...
    [27,"Things traded by veterans","WARSTORIES"],
    [30,"Outmarch?","PRIDEPARADE"],
    [32,"Some film postproduction pros","SOUNDMIXERS"],
    [33,"Scraps","TOSSESASIDE"],
    [34,"Insects named after a small bird","OWLETMOTHS"],
    [35,"\"Holy moly!\"","JEEZ"],
    ...
    [28,"Appends","ADDSON"],
    [29,"Sparklers in a treasure chest","RAREJEWELS"],
    ...
    [16,"Indulge","HUMOR"],
    [17,"Spread unit","ACRE"],
    [18,"Ingredient in some Italian sauces","ROMATOMATO"],
    ...
    [32,"Heartache","WOE"],
    [35,"It doesn't follow","NONSEQUITUR"],
    [37,"Author/TV personality who wrote \"Your body is not a temple, it's an amusement park\"","ANTHONYBOURDAIN"],
    [39,"Swear words?","SCOUTSHONOR"],
    [40,"Tech ___","BRO"],
    ...
    [53,"\"This is just wonderful!\"","IMINHEAVEN"],
    ...
    [21,"Coach for the bench players?","PIANOTEACHER"],
    ...
    [17,"Threat that's hard to take seriously","IMEANITTHISTIME"],
    ...
    [32,"Response from Siri","HERESWHATIFOUND"],
    ...
    [48,"\"Well, aren't you so darn special!\"","LAHDIFRICKINDAH"],
    [51,"Completely bought","ATEUP"],
    [52,"Juice bar ingredient","ACAIBERRY"],
    ...
    [3,"Title rock lyric before \"I'm gonna find ya / I'm gonna get ya, get ya, get ya, get ya\"","ONEWAYORANOTHER"],
    [4,"\"Heavens to Murgatroyd!\"","EGADS"],
    [5,"Alex and ___ (jewelry chain)","ANI"],
    [6,"Hits the jackpot, say","GETSRICH"],
    [7,"Exceedingly obtuse","ASTHICKASABRICK"],
    [8,"Go over","REHASH"],
    [11,"Branch of agriculture pertinent to dairy farmers and cattle ranchers","ANIMALHUSBANDRY"],
    ...
    [17,"Dish that's both hot and cold","PIEALAMODE"],
    ...
    [49,"[mic drop]","DONE"],
    [50,"Detective in an aloha shirt","ACEVENTURA"],
    ...
    [13,"Something said while nodding","INEEDANAP"],
    [15,"Or","SLASH"],
    [16,"\"Quit looking at me like that\"","DONTJUDGE"],
    [17,"Actor and L.G.B.T.Q. rights activist George","TAKEI"],
    [18,"A child who's lying might make one","SNOWANGEL"],
    ...
    [52,"Genre for \"The Truman Show\" in 1998's \"The Truman Show\"","REALITYTV"],
    [53,"Actor Elba","IDRIS"],
    [54,"Space out?","ESCAPEPOD"],
    [55,"Time out?","REST"],
    [56,"Manual part","STEP"],
    ...
    [25,"Turn out badly for everyone involved","ENDINTEARS"],
    [26,"Rib","TEASE"],
    ...
    [12,"Pop around a lot?","STAYATHOMEDAD"],
    [14,"\"Whoa, there!\"","WHATSTHEBIGIDEA"],
    ...
    [57,"Zonked","OUT"],
    [58,"\"Stop ... don't panic\"","TAKEADEEPBREATH"],
    [61,"Phil Silvers character of 1950s TV","SERGEANTBILKO"],
    [62,"Place for a hot date?","DESERTOASIS"],
    [1,"Provenance of many superheroes","STANLEE"],
    [2,"Not fast","EAT"],
    [3,"Dermatologist's concern","CYST"],
    [4,"Going amount","RATE"],
    [5,"Fifth element, to Aristotle","ETHER"],
    [6,"Heart of an academic paper","THESISSTATEMENT"],
    [7,"Key ___","FOB"],
    [8,"\"We'll see\"","IMIGHT"],
    ...
    [14,"Line outside the entrance?","OPENSESAME"],
    [16,"State flower of Utah","SEGO"],
    [17,"Using any means necessary","CATCHASCATCHCAN"],
    ...
    [37,"Setting for forensic investigations","SCENEOFTHECRIME"],
    ...
    [57,"\"Yo!\"","HEY"],
    [60,"Stereotypical cry from a sailor","SHIVERMETIMBERS"],
    [63,"Erin Doherty's role on \"The Crown\"","ANNE"],
    [64,"One involved with an operation","SCRUBNURSE"],
    [65,"Get-up","TOGS"],
    [66,"Retreats from the heat","OASES"],
    [67,"Some real heady stuff?","BEER"],
    [1,"Mezza ___","VOCE"],
    [2,"Modern register at a cashless establishment","IPAD"],
    [3,"\"Let's go!\"","BETTERGETMOVING"],
    [4,"Pkg. insert","ENC"],
    [5,"Close up","SEAL"],
    [6,"Things in the plus column","ASSETS"],
    [7,"People who might tell you to stop, but probably shouldn't","BACKSEATDRIVERS"],
    [8,"Org. that endorsed Obamacare","AMA"],
    [9,"Court suspensions?","NETS"],
    [10,"Square-cut masonry","ASHLAR"],
    [11,"George Mallory's famous response to \"Why did you want to climb Mount Everest?\"","BECAUSEITSTHERE"],
    ...
    [15,"Coat color","ROAN"],
    [16,"Question often asked after twirling","HOWDOILOOK"],
    [17,"Some O.K.s","NODS"],
    [18,"Rambo sort","ONEMANARMY"],
    ...
    [39,"Subject of a 1984 mockumentary","SPINALTAP"],
    [44,"Flag","TIRE"],
    ...
    [50,"Some baby talk","GOOGOOGAGA"],
    [53,"Rostrum","DAIS"],
    [54,"1983 hit with the line \"She's been living in her white bread world\"","UPTOWNGIRL"],
    [55,"Look at on the beach, say","OGLE"],
    [56,"College application components","TESTSCORES"],
    ...
    [15,"Modern-day \"miner\"","DATASCIENTIST"],
    ...
    [18,"Gabriel Garc\u00eda M\u00e1rquez called him \"the greatest poet of the 20th century, in any language\"","PABLONERUDA"],
    [20,"Male-or-female","GENDERBINARY"],
    [22,"Electrify","AROUSE"],
    ...
    [54,"Brand of fruit-flavored hard candy","JOLLYRANCHER"],
    [56,"\"Call sometime\"","GIVEMEARING"],
    ...
    [2,"Modern transports used while standing","HOVERBOARDS"],
    [3,"\"Nothing to get worked up about\"","ITSNOBIGGIE"],
    ...
    [21,"Really liked","DUG"],
    [24,"No longer struggling","OVERTHEHUMP"],
    [25,"Brain power like you can't believe?","TELEKINESIS"],
    ...
    [17,"Phenomenon characterized by electronic dance music","RAVECULTURE"],
    ...
    [26,"Intent","KEEN"],
    [27,"Source of rules for keeping kosher","MOSAICLAW"],
    [32,"\"___ be great ...\"","ITD"],
    [33,"Red or white container","WINEFLASK"],
    [34,"What a whole lot of kisses might result in","SUGARRUSH"],
    [35,"Stuff in a roll at a Japanese restaurant","SUSHIRICE"],
    [36,"Snap","PIC"],
    [39,"Song that a hip-hop rivalry might inspire","DISSTRACK"],
    ...
    [5,"\"Hmm, sounds like a good idea\"","IJUSTMIGHT"],
    ...
    [30,"\"Whew! That was fortunate for me\"","ILUCKEDOUT"],
    ...
    [14,"Nirvana, e.g.","INNERPEACE"],
    [16,"Part of the eye","CONE"],
    [17,"Computer file arrangement","DATAFORMAT"],
    [18,"Sharp","ACID"],
    ...
    [34,"Sobriquet for international hip-hop star Pitbull","MRWORLDWIDE"],
    [35,"Scorsese film added to the National Film Registry in 1997","MEANSTREETS"],
    [36,"\"I want it!\"","GIMME"],
    ...
    [6,"Jokey response to an overly technical explanation","NERDALERT"],
    ...
    [12,"Film part for Frank Sinatra and George Clooney","DANNYOCEAN"],
    ...
    [28,"Request to a couch hog","SCOOCHOVER"],
    ...
    [35,"Bonus feature, of a sort","EASTEREGG"],
    [39,"\"And so ...\"","THEN"],
    ...
    [26,"What \"epistaxis\" is a fancy medical term for","NOSEBLEED"],
    [30,"Play detective","SNOOP"],
    [31,"Epcot's Spaceship Earth, architecturally","GEODESICDOME"],
    [33,"Big business news","MERGER"],
    [36,"Opera with the \"Gypsy Song\"","CARMEN"],
    [37,"Treat with an edible container","ICECREAMCONE"],
    [41,"Santa ___","CLAUS"],
    [42,"Person who's whip-smart?","LIONTAMER"],
